...
k.ENVIRONMENT_IS_PTHREAD || k.$ww || function(a) {
    function b(n, p, q, u) {
        if ("object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node) require("fs").readFile(n, function(r, B) {
            ...
            w.onprogress = function(r) {
                ...
                r.total && (B = r.total);
                if (r.loaded) {
                    w.Ki ? k.Aj[n].loaded = r.loaded : (w.Ki = !0, k.Aj || (k.Aj = {}), k.Aj[n] = {
                        loaded: r.loaded,
                        total: B
                    });
                    var y = B = r = 0,
                    ...
                    r = Math.ceil(r * k.hk / y);
                    k.setStatus && k.setStatus(`Downloading data... (/)`)
                } else !k.Aj && k.setStatus && k.setStatus("Downloading data...")
            };
            w.onerror = function() {
    ...
    function d() {
        ...
        function p(w) {
            ...
            n.prototype.Qi = w;
            w = a.files;
            for (var r = 0; r < w.length; ++r) n.prototype.Ki[w[r].filename].onload();
        ...
        n.prototype = {
            ...
            send: function() {},
            onload: function() {
                this.finish(this.Qi.subarray(this.start,
                    this.end))
            },
            finish: function(w) {
    ...
    "remote_package_size": 12561615,
    "package_uuid": "b453ee75-c8fd-42b9-b49e-ccf04c59d643"
});
...
var Ca = {},
    Da = void 0;
this.__js_override_script_function = function(a, b) {
    Ca[a] = b;
    if (Da) {
        b = aa(a) + 1;
        var c = m(b);
        t(a, v, c, b);
        k.dynCall("vpi", Da, [c, 1]);
        ca(c)
    }
};
this.__js_remove_override_script_function = function(a) {
    Ca[a] = void 0;
    if (Da) {
        var b = aa(a) + 1,
            c = m(b);
        t(a, v, c, b);
        k.dynCall("vpi", Da, [c, 0]);
        ca(c)
    }
};
this.__call_override_script_function = function(a, b, c, d) {
    var e = "undefined";
    void 0 !== Ca[a] && (d = void 0 != d && "" != d ? JSON.parse(d) : [], d.unshift(c), d.unshift(b), a = Ca[a].apply(null, d), e = void 0 != a ? JSON.stringify(a) : "undefined");
    return e
};
var Ea = void 0,
    Fa = void 0,
    ...
    Ia = void 0,
    Ja = void 0;
this.__js_call_gml = function(a, b, c, d, e) {
    var f = Array.prototype.slice.call(arguments, 5);
    f = JSON.stringify(f);
    f = Ka(f);
    var g = k.dynCall("pipppp", Ga, [a, c, d, e, f]),
        h = g ? x(v, g) : "";
    h = JSON.parse(h);
    ca(g);
    ca(f);
...
this.__js_call_var = function(a, b, c, d) {
    b = (a = k.dynCall("pipp", Ia, [a, c, d])) ? x(v, a) : "";
    b = JSON.parse(b);
    ca(a);
    return b
};
this.__js_call_varSet = function(a, b, c) {
    var d = Array.prototype.slice.call(arguments, 3);
    d = JSON.stringify(d);
    d = Ka(d);
    return k.dynCall("iippp", Ja, [a, c, 0, d])
};
this.__js_get_gml = function() {
    if (void 0 == Ea && (Ea = {}, Fa)) {
        var a = k.dynCall("iipp", Fa, [-1, 0, 0]),
            b = k.dynCall("iipp", Fa, [-2, 0, 0]),
            c = k.dynCall("iippp", Ha, [-1, 0, 0, 0]),
            d = m(12),
            e = d + 4,
            f = d + 8;
        for (let p = 0; p < a; p++) {
            k.dynCall("iipp", Fa, [p, d, e]);
            var g = k.getValue(d, "*"),
                h = g ? x(v, g) : "",
                n = k.getValue(e, "*");
            Ea[h] = this.__js_call_gml.bind(this, p, h, n);
            ca(g)
        }
        for (a = 0; a < b; a++) k.dynCall("iipp", Fa, [a + 1E5, d, e]), h = (g = k.getValue(d, "*")) ? x(v, g) : "", n = k.getValue(e, "*"), Ea[h] = this.__js_call_gml.bind(this, a + 1E5, h, n), ca(g);
        for (a = 0; a < c; a++) k.dynCall("iippp",
            Ha, [a, d, e, f]), h = (g = k.getValue(d, "*")) ? x(v, g) : "", b = k.getValue(e, "*"), n = k.getValue(f, "*"), 0 != b && 0 != n ? Object.defineProperty(Ea, h, {
            get: this.__js_call_var.bind(this, a, h, b),
            set: this.__js_call_varSet.bind(this, a, h, n)
        }) : 0 != b ? Object.defineProperty(Ea, h, {
            get: this.__js_call_var.bind(this, a, h, b)
        }) : 0 != n && Object.defineProperty(Ea, h, {
            set: this.__js_call_varSet.bind(this, a, h, n)
        }), ca(g);
        ca(d)
    }
...
GXMFS = {
    lj: {},
    Si: function(a) {
        return z.Si.apply(null, arguments)
    },
    zk: (a, b, c) => {
        GXMFS.ik(a, (d, e) => {
            if (d) return c(d);
    ...
    tl: (a, b) => {
        var c = GXMFS.lj[a];
        c || (c = window.oprt.gameStorage.open(a), GXMFS.lj[a] = c);
        return b(null, c)
    },
    ik: (a, b) => {
        function c(h) {
        ...
        var e = {};
        for (a = Ma(a.oj).filter(c).map(d(a.oj)); a.length;) {
            var f = a.pop();
            try {
                var g = Na(f)
            } catch (h) {
            ...
            C(g.mode) &&
                a.push.apply(a, Ma(f).filter(c).map(d(f)));
            e[f] = {
                timestamp: g.mtime
            }
        }
    ...
    lk: (a, b) => {
        ...
        return C(d.mode) ? b(null, {
            timestamp: d.mtime,
            mode: d.mode
        }) : 32768 === (d.mode & 61440) ? (c.Mi = Pa(c), b(null, {
            timestamp: d.mtime,
            mode: d.mode,
            contents: c.Mi
    ...
    xk: (a, b, c) => {
        try {
            if (C(b.mode)) Qa(a,
                b.mode);
            else if (32768 === (b.mode & 61440)) Ra(a, b.contents);
            else return c(Error("node type not supported"));
            Sa(a, b.mode);
            Ta(a, b.timestamp, b.timestamp)
        } catch (d) {
            return c(d)
        }
        c(null)
    ...
    uk: (a, b) => {
        try {
            var c = Na(a);
            C(c.mode) ? Ua(a) : 32768 === (c.mode & 61440) && Va(a)
        } catch (d) {
            return b(d)
        }
        b(null)
...
b.type?"local filesystem":"remote filesystem"}`);
        ...
        g.sort().reverse().forEach(p => {
            "local" === b.type ? GXMFS.uk(p, d) : GXMFS.vk(n, p, d)
        })
    }
};
var Wa = Object.assign({}, k),
    Xa = [],
    Ya = "./this.program",
    Za = (a, b) => {
        throw b;
    ...
    ab = "function" == typeof importScripts,
    bb = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node,
    cb = "",
    db, eb, fb;
if (bb) {
    var fs = require("fs"),
        gb = require("path");
    cb = ab ? gb.dirname(cb) + "/" : __dirname + "/";
    db = (a, b) => {
        a = hb(a) ? new URL(a) : gb.normalize(a);
    ...
    !k.thisProgram && 1 < process.argv.length && (Ya = process.argv[1].replace(/\\/g, "/"));
    Xa = process.argv.slice(2);
    "undefined" != typeof module && (module.exports = k);
    process.on("uncaughtException", a => {
        if (!("unwind" === a || a instanceof ib || a.context instanceof ib)) throw a;
    });
    Za = (a, b) => {
        process.exitCode = a;
        throw b;
...
} else if ($a || ab) ab ? cb = self.location.href : "undefined" != typeof document && document.currentScript && (cb = document.currentScript.src), cb = 0 !== cb.indexOf("blob:") ? cb.substr(0, cb.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", db = a => {
...
var jb = k.print || console.log.bind(console),
    l = k.printErr || console.error.bind(console);
Object.assign(k, Wa);
Wa = null;
k.arguments && (Xa = k.arguments);
k.thisProgram && (Ya = k.thisProgram);
k.quit && (Za = k.quit);
var kb;
k.wasmBinary && (kb = k.wasmBinary);
"object" != typeof WebAssembly && lb("no native wasm support detected");
var mb, nb = !1,
    ob, D, v, pb, qb, E, F, H, rb;

function sb() {
    var a = mb.buffer;
    k.HEAP8 = D = new Int8Array(a);
    k.HEAP16 = pb = new Int16Array(a);
    k.HEAPU8 = v = new Uint8Array(a);
    k.HEAPU16 = qb = new Uint16Array(a);
    k.HEAP32 = E = new Int32Array(a);
    k.HEAPU32 = F = new Uint32Array(a);
    k.HEAPF32 = H = new Float32Array(a);
    k.HEAPF64 = rb = new Float64Array(a)
}
var tb = [],
    ub = [],
    vb = [],
...
function Db() {
    Ab++;
    k.monitorRunDependencies && k.monitorRunDependencies(Ab)
}
...
var Gb = a => a.startsWith("data:application/octet-stream;base64,"),
    hb = a => a.startsWith("file://"),
    Hb;
Hb = "runner.wasm";
if (!Gb(Hb)) {
    var Ib = Hb;
    Hb = k.locateFile ? k.locateFile(Ib, cb) : cb + Ib
}

function Jb(a) {
    if (a == Hb && kb) return new Uint8Array(kb);
    if (fb) return fb(a);
...
function Kb(a) {
    if (!kb && ($a || ab)) {
        if ("function" == typeof fetch && !hb(a)) return fetch(a, {
            credentials: "same-origin"
        }).then(b => {
            if (!b.ok) throw "failed to load wasm binary file at '" + a + "'";
            return b.arrayBuffer()
        }).catch(() => Jb(a));
        if (eb) return new Promise((b, c) => {
            eb(a, d => b(new Uint8Array(d)), c)
        })
    }
    return Promise.resolve().then(() => Jb(a))
}

function Lb(a, b, c) {
    return Kb(a).then(d => WebAssembly.instantiate(d, b)).then(d => d).then(c, d => {
...
function Mb(a, b) {
    var c = Hb;
    kb || "function" != typeof WebAssembly.instantiateStreaming || Gb(c) || hb(c) || bb || "function" != typeof fetch ? Lb(c, a, b) : fetch(c, {
        credentials: "same-origin"
...
var I, J, Vb = {
    1535256: (a, b, c, d) => {
        a = __call_override_script_function(a ? x(v, a) : "", b, c, d ? x(v, d) : "");
        return Ka(a)
    },
    1535378: () => hasJSExceptionHandler(),
    1535443: a => {
        doJSExceptionHandler(a ? x(v, a) : "")
    },
    1535487: a => {
        window.parent.postMessage(a ? x(v, a) : "", "*")
    },
    1535541: () => document.querySelector("canvas").getBoundingClientRect().left,
    1535661: () => document.querySelector("canvas").getBoundingClientRect().top,
    1535780: () => {
    ...
    1536046: (a, b, c, d, e, f) => {
        gxc_request_room(a ? x(v, a) : "", b ? x(v, b) : "", c, d, e ? x(v, e) : "", f ? x(v, f) : "")
    },
    1536148: (a, b, c, d) => {
    ...
    1536737: (a, b) => {
        ...
        if (c && "visible" == c.style.visibility) {
            if (c = document.getElementById("multiplayer-stats")) c.innerHTML = a ? x(v, a) : "";
    ...
    1537154: () => {
        ...
        if (a =
            document.getElementById("share-button")) a.style.visibility = "hidden";
    ...
    1537853: (a,
        b) => webtransport_set_relay(a ? x(v, a) : "", b),
    1537910: a => {
    ...
    1537975: (a, b, c) => webtransport_receive(a, b, c),
    1538020: a => {
        "function" == typeof wallpaper_init_config_controls && wallpaper_init_config_controls(JSON.parse(a ? x(v, a) : ""))
    },
    1538147: a => {
        "function" == typeof wallpaper_init_subscriptions && wallpaper_init_subscriptions(JSON.parse(a ? x(v, a) : ""))
    },
    1538270: a => {
        alert(a ? x(v, a) : "")
    },
    ...
    1538774: a => {
        a = window.open(a ? x(v, a) : "", "_blank");
        null != a && a.focus()
    },
    1538859: () => Ka(navigator.userAgent.toString()),
    1538934: () => Ka(window.location.href),
    1538999: () => {
        var a = document.querySelector("canvas");
        null != a.Ki && (a.Ki.pause(),
            a.Ki.removeAttribute("src"), a.Ki.load(), console.log("Closing video player"), a.Ki.remove(), a.Ki = null)
    },
    1539317: (a, b, c) => {
        var d = document.querySelector("canvas");
        if (null != d.Mj) return b = d.Mj.getImageData(0, 0, b, c), b = new Uint8Array(b.data.buffer), D.set(b, a), 1;
    ...
    1539949: () => {
        var a = document.querySelector("canvas");
        return null == a.Ki || a.Ki.ended ? -1 : 0
    },
    1540104: a => {
    ...
    1540237: a => {
        function b() {
            function h() {
                const q = document.querySelector("canvas").Ki;
                null != q && (q.muted = !1)
            }
            console.log("Adding unmute listener");
            var n = "mousedown",
                p = "mouseup";
            ...
            console.log("Done unmute listener")
        }
        const c = () => {
            var h = document.querySelector("canvas");
            null !== h.Ki && (null == h.$i ? (h.$i = document.createElement("canvas"), h.$i.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px", h.$i.width = h.Ki.videoWidth, h.$i.height = h.Ki.videoHeight, document.body.appendChild(h.$i), h.Mj = h.$i.getContext("2d", {
                    alpha: !1,
                    Yl: !1,
                ...
                (h.Ki.videoWidth != h.$i.width && (h.$i.width = h.Ki.videoWidth), h.$i.height != h.Ki.videoHeight && (h.$i.height = h.Ki.videoHeight)), null != h.Ki && null != h.Mj ? h.Mj.drawImage(h.Ki, 0, 0) : console.log("player or context is null not drawing video"), null != h.Ki ? null != h.Ki.src ? h.Ki.requestVideoFrameCallback(c) : console.log("stopping video player callback check") : console.log("Not requesting callback as videoplayer is null"))
        };
        var d = document.querySelector("canvas");
        null == d.Ki ? d.Ki = document.createElement("video") : (d.Ki.remove(),
            d.Ki = document.createElement("video"), d.Ki.pause());
        a = a ? x(v, a) : "";
        var e = void 0;
        try {
            e = JSON.parse(a)
        } catch {}
        console.log("using srcpath:" + a);
        void 0 !== e ? "mediaDevices" in navigator && "getUserMedia" in navigator.mediaDevices ? (console.log("getUserMedia supported"), navigator.mediaDevices.getUserMedia(e).then(h => {
                console.log("getUserMedia completed");
                d.Ki.srcObject = h;
                d.Ki.requestVideoFrameCallback(c)
            }).catch(h => {
                console.error("Error accessing the camera: ", h)
            })) : console.log("no getUserMedia support in this browser") :
            (console.log("Failed to parse json, presuming it's a path:" + a), d.Ki.muted = !1, a = a.toLowerCase(), a = a.replace(/ /g, "_"), console.log("Converted path to:" + a), d.Ki.src = a, d.Ki.requestVideoFrameCallback(c), d.Ki.load());
        const f = {
        ...
        console.log("About to add ended callback");
        d.Ki.addEventListener("ended", function() {
            f.Rl()
        });
        console.log("About to add playing callback");
        d.Ki.addEventListener("playing", function() {
    ...
    1546554: (a, b, c, d) => {
        ...
        e.Ek.getVideoTracks().find(g =>
            g.enabled);
        null == e.gj && (e.gj = document.createElement("canvas"), e.gj.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px", e.gj.width = a, e.gj.height = b, document.body.appendChild(e.gj), console.log("Game Canvas width:" + e.width + " height:" + e.height), e.bl = e.gj.getContext("2d", {
                alpha: !1,
                desynchronized: !0,
                antialias: !0,
                powerPreference: "low-power",
                preserveDrawingBuffer: !0
            }), e.rj = document.createElement("video"), e.rj.autoplay = !0, e.rj.Vl = !0, e.rj.muted = !0, e.rj.style.cssText = "position:fixed;top:1px;left:1px;width:1px;height:1px",
            document.body.appendChild(e.rj), e.rj.srcObject = e.Ek, a = e.gj.captureStream(c), 0 < d && (d = da.createMediaStreamDestination().stream.getAudioTracks().find(g => g.enabled), a.addTrack(d)), f = new MediaRecorder(a, f), e.jj = [], f.ondataavailable = function(g) {
                e.jj.push(g.data)
            }, e.Qi = f);
        null == e.bk && (e.bk = setInterval(() => e.bl.drawImage(e.rj, 0, 0, e.width, e.height, 0, 0, e.gj.width, e.gj.height), 1E3 / c));
        e.Qi && "recording" != e.Qi.state && e.Qi.start()
    },
    1549050: a => {
        var b = document.querySelector("canvas");
        if (b.Qi && ("recording" == b.Qi.state ||
                "paused" == b.Qi.state)) {
            var c = a ? x(v, a) : "";
            b.Qi.onstop = function() {
                ...
                b.bk = null;
                const e = {
                    qk: k.cwrap("post_video_upload_callback", "", ["string"])
                };
                if (c.startsWith("http")) fetch(c, {
                    method: "PUT",
                    body: d
                }).then(() => {
                    e.qk("upload completed")
                }).catch(g => {
                    e.qk("Error uploading: " + g)
                });
                else if ("" != c) {
    ...
    1550585: (a, b) => {
        triggerPayment(a ? x(v, a) : "", b)
    },
    1550627: () => {
        Nb(!0, function() {
            Ob("GXC_FSSyncCompleted", "void")
        })
    },
    1550702: () => {
        var a = 640;
        "number" == typeof window.innerWidth ? a = window.innerWidth *
            window.devicePixelRatio : document.documentElement && document.documentElement.clientWidth ? a = document.documentElement.clientWidth : document.body && document.body.clientWidth && (a = document.body.clientWidth);
        return a
    },
    1551034: () => {
        var a = void 0;
    ...
    1551528: (a, b, c, d) => {
        ...
        if (void 0 != window.oprt) {
            ...
            0 != (a & 5) && void 0 != h && "function" == typeof h ? (h(), console.log("Locking to Landscape"), e = 0) : 0 != (a & 10) &&
                void 0 != g && "function" == typeof g && (g(), console.log("Locking to Portrait"), e = 0)
        }
        return e
    },
    1552516: a => {
    ...
    1553044: () => screen.width,
    1553069: () => screen.height,
    1553095: (a, b) => {
    ...
    1553371: () => {
        var a = document.getElementById("canvas").getContext("webgl"),
            b = a.getExtension("WEBGL_compressed_texture_astc");
        null == b && console.log("Failed to get WEBGL_compressed_texture_astc extension.");
        b =
            a.getExtension("WEBGL_compressed_texture_s3tc");
        null == b && console.log("Failed to get WEBGL_compressed_texture_s3tc extension.");
        b = a.getExtension("WEBGL_compressed_texture_s3tc_srgb");
        null == b && console.log("Failed to get WEBGL_compressed_texture_s3tc_srgb extension.")
    },
    1553964: () => screen.width,
    1553989: () => screen.height,
    1554015: () => screen.width,
    1554040: () => screen.height,
    1554066: () => {
    ...
    1554520: a => __gx_check_cache(a ? x(v, a) : "", !0) ? 1 : 0,
    1554582: (a, b, c, d, e, f, g, h) => {
    ...
    1554679: () => {
        (function() {
            function a() {
                try {
                    console.log("Requesting permission"), DeviceMotionEvent && "function" === typeof DeviceMotionEvent.requestPermission ? DeviceMotionEvent.requestPermission().then(e => {
                        ({
                            Vj: k.cwrap("on_request_permission_callback",
                                "", ["string", "string"])
                        }).Vj(e, "DeviceMotion")
                    }) : b.Vj("Permission unknown", "DeviceMotion")
                } catch (e) {
                    b.Vj("Permission unknown", "DeviceMotion")
                }
            }
            const b = {
                Vj: k.cwrap("on_request_permission_callback", "", ["string", "string"])
            };
            var c = "mousedown",
                d = "mouseup";
            "ontouchstart" in window && (c = "touchstart", d = "touchend");
            if (window.PointerEvent || window.navigator.pointerEnabled || window.navigator.msPointerEnabled) c = "pointerdown", d = "pointerup";
    ...
    1556242: () => {
        window.addEventListener("deviceorientation", function(a) {
            ({
                Fl: k.cwrap("on_orientation_update_callback", "", ["float", "float", "float"])
            }).Fl(a.alpha, a.beta, a.gamma)
        }, !0);
        window.addEventListener("message", a => {
            const b = {
                Wk: k.cwrap("on_post_message_callback",
                    "", ["string", "string"])
            };
            "string" === typeof a.data || a.data instanceof String ? b.Wk(a.data, a.origin) : b.Wk(JSON.stringify(a.data), a.origin)
        });
        window.parent.postMessage("gm_post_message_listener_setup_complete", "*")
    },
    1556959: a => __gx_check_cache(a ? x(v, a) : "", !1) ? 1 : 0,
    1557020: (a, b) => {
        g_pWadLoadCallback && g_pWadLoadCallback(a, b)
    },
    1557080: a => {
    ...
    1557190: (a, b) => {
        this.chrome && this.chrome.runtime && chrome.runtime.sendMessage(a ?
            x(v, a) : "", {
                command: b ? x(v, b) : ""
            })
    },
    1557327: (a, b, c, d, e) => {
        ...
        const g = {
            cl: k.cwrap("YYSum", "", ["number", "number"])
        };
    ...
    1557887: () => window.matchMedia("(any-hover: none)").matches || window.matchMedia("(any-hover: hover) and (pointer: coarse)").matches || "undefined" !=
        typeof window.oprt,
    1558060: (a, b, c, d, e, f, g) => {
        qa = a;
        ra = b;
        ua = c;
        va = d;
    ...
    1558929: () => {
        ...
        window.oprt && window.oprt.gameStorage ?
            Qb(GXMFS, "/_savedata") : Qb(K, "/_savedata");
        Nb(!0, function() {
            Ob("FSSyncCompleted", "void")
        })
    },
    1559151: () => {
        Nb(!1, function() {})
    ...
    1560516: () => null ==
        da ? 0 : da.currentTime,
    1560594: () => null == da ? 0 : da.sampleRate,
    1560671: () => null == da ? 0 : da.destination.channelCount,
    1560760: (a, b, c, d, e, f) => {
        e = da.createBuffer(b, d, e);
        for (let g = 0; g < b; ++g) {
            const h = e.getChannelData(g);
            for (let n = 0; n < d; ++n) h[n] = Rb(a + c * (g + n * b), "float")
        }
    ...
    1563775: (a, b, c) => {
        ...
        for (let d = 0; d < b; ++d) {
            const e = ea.shift();
            for (let f = 0; f < c; ++f) Sb(a + 2 * (d * c + f), e[f], "i16")
        }
    },
    1564119: a => ea.length * a,
    1564205: () => null != ha && null != ka ? 1 : 0,
    1564318: () => "undefined" !== typeof AudioContext || "undefined" !== typeof webkitAudioContext ?
        !0 : !1,
    1564465: () => "undefined" !== typeof navigator.mediaDevices && "undefined" !== typeof navigator.mediaDevices.getUserMedia || "undefined" !== typeof navigator.webkitGetUserMedia ? !0 : !1,
    1564699: a => {
        "undefined" === typeof k.SDL2 && (k.SDL2 = {});
        var b = k.SDL2;
        a ? b.capture = {} : b.audio = {};
        b.Ri || ("undefined" !== typeof AudioContext ? b.Ri = new AudioContext : "undefined" !== typeof webkitAudioContext && (b.Ri = new webkitAudioContext), b.Ri && Tb(b.Ri));
        return void 0 === b.Ri ? -1 : 0
    },
    1565192: () => k.SDL2.Ri.sampleRate,
    1565260: (a, b, c, d) => {
        function e() {}

        function f(h) {
            void 0 !== g.capture.Jj && (clearTimeout(g.capture.Jj), g.capture.Jj = void 0);
            g.capture.Tj = g.Ri.createMediaStreamSource(h);
            g.capture.Ui = g.Ri.createScriptProcessor(b, a, 1);
            g.capture.Ui.onaudioprocess = function(n) {
                void 0 !== g && void 0 !== g.capture && (n.outputBuffer.getChannelData(0).fill(0), g.capture.ek = n.inputBuffer, Ub("vi", c, [d]))
            };
            g.capture.Tj.connect(g.capture.Ui);
            g.capture.Ui.connect(g.Ri.destination);
            g.capture.stream = h
        }
        var g = k.SDL2;
        g.capture.Xj = g.Ri.createBuffer(a, b, g.Ri.sampleRate);
        g.capture.Xj.getChannelData(0).fill(0);
        g.capture.Jj = setTimeout(function() {
            g.capture.ek = g.capture.Xj;
            Ub("vi", c, [d])
    ...
    1566912: (a, b, c, d) => {
        var e = k.SDL2;
        e.audio.Ui = e.Ri.createScriptProcessor(b, 0, a);
        e.audio.Ui.onaudioprocess = function(f) {
            void 0 !== e && void 0 !== e.audio && (e.audio.Lk =
                f.outputBuffer, Ub("vi", c, [d]))
        };
        e.audio.Ui.connect(e.Ri.destination)
    },
    1567322: (a, b) => {
        for (var c = k.SDL2, d = c.capture.ek.numberOfChannels, e = 0; e < d; ++e) {
            var f = c.capture.ek.getChannelData(e);
            if (f.length != b) throw "Web Audio capture buffer length mismatch! Destination size: " + f.length + " samples vs expected " + b + " samples!";
            if (1 == d)
                for (var g = 0; g < b; ++g) Sb(a + 4 * g, f[g], "float");
            else
                for (g = 0; g < b; ++g) Sb(a + 4 * (g * d + e), f[g], "float")
        }
    },
    1567927: (a, b) => {
        for (var c = k.SDL2, d = c.audio.Lk.numberOfChannels, e = 0; e < d; ++e) {
            var f = c.audio.Lk.getChannelData(e);
    ...
    1568407: a => {
        var b = k.SDL2;
        if (a) {
            void 0 !== b.capture.Jj && clearTimeout(b.capture.Jj);
            ...
            void 0 !== b.capture.Ui && (b.capture.Ui.onaudioprocess = function() {}, b.capture.Ui.disconnect(), b.capture.Ui =
                void 0);
            void 0 !== b.capture.Tj && (b.capture.Tj.disconnect(), b.capture.Tj = void 0);
            void 0 !== b.capture.Xj && (b.capture.Xj = void 0);
            b.capture = void 0
        } else void 0 != b.audio.Ui && (b.audio.Ui.disconnect(), b.audio.Ui = void 0), b.audio = void 0;
        void 0 !== b.Ri && void 0 === b.audio && void 0 === b.capture && (b.Ri.close(), b.Ri = void 0)
    },
    1569579: (a, b, c) => {
        k.SDL2 || (k.SDL2 = {});
        var d = k.SDL2;
        d.gl !== k.canvas && (d.bj = k.createContext(k.canvas, !1, !0), d.gl = k.canvas);
        if (d.w !== a || d.h !== b || d.vl !== d.bj) d.image = d.bj.createImageData(a, b), d.w = a, d.h =
            b, d.vl = d.bj;
        a = d.image.data;
        b = c >> 2;
        var e = 0;
        if ("undefined" !== typeof CanvasPixelArray && a instanceof CanvasPixelArray)
            for (c = a.length; e < c;) {
                ...
                b++;
                e += 4
            } else if (d.jl !== a && (d.il = new Int32Array(a.buffer), d.kl = new Uint8Array(a.buffer), d.jl = a), a = d.il, c = a.length, a.set(E.subarray(b, b + c)), a = d.kl, b = 3, e = b + 4 * c, 0 == c % 8)
    ...
    1572037: a => {
        k.canvas && (k.canvas.style.cursor = a ? x(v, a) : "")
    },
    1572120: () => {
        k.canvas && (k.canvas.style.cursor = "none")
    },
    1572189: () => window.innerWidth,
    1572219: () => window.innerHeight
};
...
var Wb = (a, b, c) => {
    ...
    Zb, M = a => {
        var b = Yb[a];
        b || (a >= Yb.length && (Yb.length = a + 1), Yb[a] = b = Zb.get(a));
        return b
    },
    Ub = (a, b, c) => {
...
function Rb(a, b = "i8") {
    ...
    switch (b) {
        ...
        case "i32":
            return E[a >> 2];
        case "i64":
            lb("to do getValue(i64) use WASM_BIGINT");
        case "float":
            return H[a >> 2];
        case "double":
            return rb[a >> 3];
        case "*":
            return F[a >> 2];
        default:
            lb(`invalid type for getValue: `)
    }
}
var $b = k.noExitRuntime || !0;

function Sb(a, b, c = "i8") {
    c.endsWith("*") && (c = "*");
    switch (c) {
        case "i1":
            D[a >> 0] = b;
        ...
        case "i32":
            ...
            break;
        case "i64":
            lb("to do setValue(i64) use WASM_BIGINT");
        case "float":
            H[a >> 2] = b;
            break;
        case "double":
...
var ic = (a, b) => {
    ...
    jc = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0,
    x = (a, b, c) => {
        var d = b + c;
        for (c = b; a[c] && !(c >= d);) ++c;
        if (16 < c - b &&
            a.buffer && jc) return jc.decode(a.subarray(b, c));
        for (d = ""; b < c;) {
            var e = a[b++];
            if (e & 128) {
                var f = a[b++] & 63;
...
var pc = {
        open(a) {
            var b = mc[a.node.rdev];
            if (!b) throw new N(43);
            a.tty = b;
            a.seekable = !1
        },
        close(a) {
            a.tty.ij.fsync(a.tty)
        },
        fsync(a) {
            a.tty.ij.fsync(a.tty)
        },
        read(a, b, c, d) {
            if (!a.tty || !a.tty.ij.Ok) throw new N(60);
            for (var e = 0, f = 0; f < d; f++) {
                try {
                    var g = a.tty.ij.Ok(a.tty)
                } catch (h) {
                    throw new N(29);
                }
        ...
        write(a, b, c, d) {
            if (!a.tty || !a.tty.ij.rk) throw new N(60);
            try {
                for (var e = 0; e < d; e++) a.tty.ij.rk(a.tty, b[c +
                    e])
            } catch (f) {
                throw new N(29);
            }
    ...
    qc = {
        ...
        rk(a, b) {
            null === b || 10 === b ? (jb(x(a.output, 0)), a.output = []) : 0 != b && a.output.push(b)
        },
        fsync(a) {
            a.output && 0 < a.output.length && (jb(x(a.output, 0)), a.output = [])
        },
        yl() {
            return {
                bm: 25856,
...
var z = {
        ...
        createNode(a, b, c, d) {
            ...
            z.ej || (z.ej = {
                dir: {
                    node: {
                        ...
                        unlink: z.Li.unlink,
                        rmdir: z.Li.rmdir,
                        readdir: z.Li.readdir,
                        symlink: z.Li.symlink
                    },
                    stream: {
                        vj: z.Ni.vj
                    }
            ...
            c = uc(a, b, c, d);
            C(c.mode) ? (c.Li = z.ej.dir.node, c.Ni = z.ej.dir.stream, c.Mi = {}) : 32768 === (c.mode & 61440) ? (c.Li = z.ej.file.node, c.Ni = z.ej.file.stream, c.Oi = 0, c.Mi = null) : 40960 === (c.mode & 61440) ? (c.Li = z.ej.link.node, c.Ni = z.ej.link.stream) : 8192 === (c.mode & 61440) && (c.Li = z.ej.Kk.node, c.Ni = z.ej.Kk.stream);
        ...
        Li: {
            dj(a) {
                ...
                b.gid = 0;
                b.rdev = a.rdev;
                C(a.mode) ? b.size = 4096 : 32768 === (a.mode & 61440) ? b.size = a.Oi : 40960 === (a.mode & 61440) ? b.size = a.link.length : b.size = 0;
                b.atime = new Date(a.timestamp);
                b.mtime = new Date(a.timestamp);
                b.ctime = new Date(a.timestamp);
                b.fl = 4096;
                b.blocks = Math.ceil(b.size / b.fl);
                return b
            },
            Vi(a, b) {
                void 0 !== b.mode && (a.mode = b.mode);
                void 0 !== b.timestamp && (a.timestamp = b.timestamp);
                if (void 0 !== b.size && (b = b.size, a.Oi != b))
                    if (0 == b) a.Mi = null, a.Oi = 0;
                    else {
                        var c = a.Mi;
                        a.Mi = new Uint8Array(b);
                        c && a.Mi.set(c.subarray(0,
                            Math.min(b, a.Oi)));
                        a.Oi = b
                    }
            },
            ...
            rename(a, b, c) {
                if (C(a.mode)) {
                    ...
                    if (d)
                        for (var e in d.Mi) throw new N(55);
                }
            ...
            readdir(a) {
                var b = [".", ".."],
                    c;
                for (c in a.Mi) a.Mi.hasOwnProperty(c) &&
                    b.push(c);
                return b
            },
            symlink(a, b, c) {
        ...
        Ni: {
            ...
            write(a, b, c, d, e, f) {
                ...
                if (b.subarray && (!a.Mi || a.Mi.subarray)) {
                    if (f) return a.Mi = b.subarray(c, c + d), a.Oi =
                        d;
    ...
    xc = (a, b, c) => {
        var d = `al `;
        eb(a, e => {
            e || lb(`Loading data file "" failed (no arrayBuffer).`);
            b(new Uint8Array(e));
            d && Eb(d)
        }, () => {
            if (c) c();
    ...
    Dc = (a, b, c, d, e, f, g, h, n, p) => {
        ...
        var u = b ? gc(La(a + "/" + b)) : a,
            w = `cp `;
        Db(w);
        "string" == typeof c ? xc(c, r => q(r), g) : q(c)
    },
    Ec = (a, b) => {
        var c = 0;
        a && (c |= 365);
    ...
    K = {
        ...
        indexedDB: () => {
            ...
            a || lb("IDBFS used, but indexedDB not supported");
            return a
        },
        al: 21,
        qj: "FILE_DATA",
        ...
        Hl: () => {
            Object.values(K.lj).forEach(a => a.close());
            K.lj = {}
        },
        sl: (a, b) => {
            var c = K.lj[a];
            ...
            d.onupgradeneeded =
                e => {
                    ...
                    var g;
                    f.objectStoreNames.contains(K.qj) ? g = e.objectStore(K.qj) : g = f.createObjectStore(K.qj);
        ...
        jk: (a, b) => {
            ...
            K.sl(a.oj, (d, e) => {
                if (d) return b(d);
                try {
                    var f = e.transaction([K.qj], "readonly");
                    f.onerror = g => {
                        b(g.target.error);
                        g.preventDefault()
                    };
                    f.objectStore(K.qj).index("timestamp").openKeyCursor().onsuccess = g => {
                        g = g.target.result;
                        if (!g) return b(null, {
                            type: "remote",
                            db: e,
        ...
        sk: (a, b, c) => {
            ...
            if (!e) return c(null);
            var h = !1,
                n = ("remote" === a.type ? a.db : b.db).transaction([K.qj], "readwrite"),
                p = n.objectStore(K.qj);
            n.onerror = q => {
                d(this.error);
                q.preventDefault()
            };
            ...
            g.sort().reverse().forEach(q => {
                "local" === b.type ? K.uk(q, d) : K.vk(p, q, d)
            })
        }
    },
    Fc = null,
...
function Oa(a, b = {}) {
    ...
    if (8 < b.tk) throw new N(32);
    a = a.split("/").filter(g => !!g);
    for (var c = Fc, d = "/", e = 0; e < a.length; e++) {
        var f = e === a.length - 1;
        if (f && b.parent) break;
        c = wc(c, a[e]);
        d = La(d + "/" + a[e]);
        c.nj && (!f || f && b.Mk) && (c = c.nj.root);
        if (!f || b.tj)
            for (f = 0; 40960 === (c.mode & 61440);)
                if (c = Mc(d), d = gc(cc(d), c), c = Oa(d, {
                        tk: b.tk + 1
                    }).node, 40 < f++) throw new N(32);
    }
    return {
        path: d,
        node: c
...
function Nc(a) {
    for (var b;;) {
        if (a === a.parent) return a = a.Si.oj, b ? "/" !== a[a.length - 1] ? `/` : a + b : a;
        b = b ? `${a.name}/` : a.name;
        a = a.parent
    }
}
...
function Oc(a, b) {
    ...
    return (a + c >>> 0) % Jc.length
}

function Pc(a) {
    var b = Oc(a.parent.id, a.name);
    a.Bj = Jc[b];
    Jc[b] = a
}
...
function wc(a, b) {
    var c;
    if (c = (c = Rc(a, "x")) ? c : a.Li.lookup ? 0 : 2) throw new N(c, a);
    for (c = Jc[Oc(a.id, b)]; c; c = c.Bj) {
        var d = c.name;
...
function Vc(a, b, c) {
    ...
    if (a = Rc(a, "wx")) return a;
    if (c) {
        if (!C(d.mode)) return 54;
        if (d === d.parent || Nc(d) === hc) return 10
...
function Zc(a, b = -1) {
    $c || ($c = function() {
        this.Ki = {}
    }, $c.prototype = {}, Object.defineProperties($c.prototype, {
        object: {
            get() {
                return this.node
            },
    ...
    a = Object.assign(new $c, a); - 1 == b && (b = Xc());
    a.fd = b;
    return Hc[b] = a
}
var tc = {
    open(a) {
        a.Ni = Gc[a.node.rdev].Ni;
...
function Nb(a, b) {
    ...
    function d(g) {
        if (g) {
            if (!d.nl) return d.nl = !0, c(g)
        } else ++f >= e.length && c(null)
    }
    "function" == typeof a && (b = a, a = !1);
    Lc++;
    1 < Lc && l(`warning:  FS.syncfs operations in flight at once, probably just doing extra work`);
    var e = ad(),
        f = 0;
    e.forEach(g => {
        if (!g.type.zk) return d(null);
        g.type.zk(g, a, d)
    })
}
...
function Qb(a, b) {
    ...
    if (!c && !d) {
        ...
        b = e.path;
        e = e.node;
        if (e.nj) throw new N(10);
        if (!C(e.mode)) throw new N(54);
    }
    b = {
        type: a,
        om: {},
    ...
    a.Si = b;
    b.root = a;
    c ? Fc = a : e && (e.nj = b, e.Si && e.Si.Tk.push(b))
}
...
function bd(a, b, c) {
    ...
    var e = Uc(d, a);
    if (e) throw new N(e);
    if (!d.Li.Uj) throw new N(63);
    return d.Li.Uj(d, a, b, c)
}
...
function dd(a, b) {
    ...
    var d = Uc(c, b);
    if (d) throw new N(d);
    if (!c.Li.symlink) throw new N(63);
    c.Li.symlink(c, b, a)
}
...
function Ua(a) {
    ...
    var c = wc(b, a),
        d = Vc(b, a, !0);
    if (d) throw new N(d);
    if (!b.Li.rmdir) throw new N(63);
    if (c.nj) throw new N(10);
    b.Li.rmdir(b, a);
    Qc(c)
}
...
function Ma(a) {
    ...
    if (!a.Li.readdir) throw new N(54);
...
function Mc(a) {
    a = Oa(a).node;
    if (!a) throw new N(44);
    if (!a.Li.readlink) throw new N(28);
    return gc(Nc(a.parent), a.Li.readlink(a))
}
...
function fd(a, b, c) {
    ...
    if (b & 65536 && !C(e.mode)) throw new N(54);
    if (!d &&
        (c = e ? 40960 === (e.mode & 61440) ? 32 : C(e.mode) && ("r" !== Tc(b) || b & 512) ? 31 : Rc(e, Tc(b)) : 44)) throw new N(c);
    if (b & 512 && !d) {
        c = e;
        c = "string" == typeof c ? Oa(c, {
            tj: !0
        }).node : c;
        if (!c.Li.Vi) throw new N(63);
        if (C(c.mode)) throw new N(31);
        if (32768 !== (c.mode & 61440)) throw new N(28);
        if (d = Rc(c, "w")) throw new N(d);
        c.Li.Vi(c, {
            size: 0,
            timestamp: Date.now()
        })
    ...
    !k.logReadFiles || b & 1 || (gd || (gd = {}), a in gd || (gd[a] = 1));
    return e
}
...
function jd(a, b, c) {
    if (null === a.fd) throw new N(8);
    if (!a.seekable || !a.Ni.vj) throw new N(70);
    if (0 != c && 1 != c && 2 != c) throw new N(28);
    a.position = a.Ni.vj(a, b, c);
    a.Pl = [];
    return a.position
}
...
function kd(a, b, c, d, e, f) {
    ...
    if (C(a.node.mode)) throw new N(31);
    if (!a.Ni.write) throw new N(28);
    a.seekable && a.flags & 1024 && jd(a, 0, 2);
...
function Ra(a, b) {
    ...
    c.flags = c.flags || 577;
    a = fd(a, c.flags, c.mode);
    if ("string" == typeof b) {
        var d = new Uint8Array(aa(b) + 1);
        b = t(b, d, 0, d.length);
        kd(a, d, 0, b, void 0, c.Ik)
    } else if (ArrayBuffer.isView(b)) kd(a, b, 0, b.byteLength, void 0, c.Ik);
...
function ld() {
    N || (N = function(a, b) {
        ...
        vc[a] = new N(a);
        vc[a].stack = "<generic error, no stack>"
    }))
}
var md;

function nd(a, b) {
    a = "string" == typeof a ? a : Nc(a);
...
function Cc(a, b, c, d, e, f) {
    var g = b;
    a && (a = "string" == typeof a ? a : Nc(a), g = b ? La(a + "/" + b) : a);
    a = Ec(d, e);
    g = bd(g, (void 0 !== a ? a : 438) & 4095 | 32768, 0);
    if (c) {
        if ("string" == typeof c) {
            b = Array(c.length);
            d = 0;
...
function qd(a) {
    if (!(a.Bl || a.Cl || a.link || a.Mi)) {
        ...
        if (db) try {
            a.Mi = lc(db(a.url), !0), a.Oi = a.Mi.length
        } catch (b) {
            throw new N(29);
...
function rd(a, b, c, d, e) {
    ...
    f.prototype.get = function(q) {
        if (!(q > this.length - 1 || 0 > q)) {
            ...
            return this.Pk(q / this.chunkSize | 0)[u]
        }
    };
    f.prototype.Ki = function(q) {
        this.Pk = q
    };
    f.prototype.Hk = function() {
        ...
        y.Ki(G => {
            var L = G * B,
                O = (G + 1) * B - 1;
            O = Math.min(O, u - 1);
            if ("undefined" == typeof y.jj[G]) {
                var A = y.jj;
                if (L > O) throw Error("invalid range (" + L + ", " + O + ") or no bytes requested!");
                if (O > u - 1) throw Error("only " + u + " bytes available! programmer error!");
                var P = new XMLHttpRequest;
                P.open("GET", c, !1);
                u !== B && P.setRequestHeader("Range", "bytes=" + L + "-" + O);
                ...
                L = void 0 !== P.response ? new Uint8Array(P.response || []) : lc(P.responseText || "", !0);
                A[G] = L
            }
            if ("undefined" == typeof y.jj[G]) throw Error("doXHR failed!");
            return y.jj[G]
        });
        if (q || !u) B = u = 1, B = u = this.Pk(0).length, jb("LazyFiles on gzip forces download of the whole file when length is accessed");
        this.el = u;
        this.dl = B;
        this.kk = !0
    };
    if ("undefined" != typeof XMLHttpRequest) {
        if (!ab) throw "Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc";
        var g = new f;
    ...
    p.read = (q, u, w, r, B) => {
        ...
        if (B >= q.length) u = 0;
            ...
            r = Math.min(q.length -
                B, r);
            if (q.slice)
                for (var y = 0; y < r; y++) u[w + y] = q[B + y];
            else
                for (y = 0; y < r; y++) u[w + y] = q.get(B + y);
            u = r
        }
        return u
    };
...
var sd = {},
    $c, gd, td = (a, b) => a ? x(v, a, b) : "";

function ud(a, b, c) {
    if ("/" === b.charAt(0)) return b;
    a = -100 === a ? hc : Yc(a).path;
    if (0 == b.length) {
        if (!c) throw new N(44);
        return a
    }
...
function vd(a, b, c) {
    try {
        ...
        if (f && f.node && La(b) !== La(Nc(f.node))) return -54;
        throw f;
    }
    E[c >> 2] = d.dev;
    E[c + 4 >> 2] = d.mode;
...
var yd = a => 0 === a % 4 && (0 !== a % 100 || 0 === a % 400),
    ...
    Kd = (a, b) => {
        ...
        Cd = b;
        if (Dd)
            if (Ed || (Ed = !0), 0 == a) Fd = function() {
                var d = Math.max(0, Gd + b - Hd()) | 0;
                setTimeout(Id, d)
            };
            else if (1 == a) Fd = function() {
            Jd(Id)
        };
        else if (2 == a) {
            if ("undefined" == typeof setImmediate) {
                ...
                setImmediate = function(d) {
                    c.push(d);
                    ab ? (void 0 === k.setImmediates && (k.setImmediates = []), k.setImmediates.push(d), postMessage({
                        target: "setimmediate"
...
Hd = () => performance.now();
var Rd = a => {
        !Dd || lb("emscripten_set_main_loop: there can only be one main loop function at once: call emscripten_cancel_main_loop to cancel the previous one before setting a new one with different parameters.");
        Dd = a;
        var b = Ld;
        Ed = !1;
        Id = function() {
            if (!nb)
                if (0 < Md.length) {
                    ...
                    k.setStatus && (c = k.statusMessage || "Please wait...", d = Nd, e = Od.hm, d ? d < e ? k.setStatus(c + " (" + (e - d) + "/" + e + ")") : k.setStatus(c) : k.setStatus(""));
                    b <
                        Ld || setTimeout(Id, 0)
                } else if (!(b < Ld))
                if (Pd = Pd + 1 | 0, 1 == Bd && 1 < Cd && 0 != Pd % Cd) Fd();
                else {
                    0 == Bd && (Gd = Hd());
                    if (R)
                        for (c = R.Dj, R.Dj = R.Kj, R.Kj = c, c = R.pj, R.pj = R.Zj, R.Zj = c, c = 0; 21 >= c; ++c) R.pj[c] = 0;
                    nb || k.preMainLoop && !1 === k.preMainLoop() || (Qd(a), k.postMainLoop && k.postMainLoop());
                    b < Ld || ("object" == typeof SDL && SDL.audio && SDL.audio.Gl && SDL.audio.Gl(), Fd())
                }
        }
    },
    Sd = a => {
        a instanceof ib || "unwind" == a || Za(1, a)
    },
    Td = a => {
        ob = a;
        if (!$b) {
...
function Ac() {
    function a() {
        Xd = document.pointerLockElement === k.canvas || document.mozPointerLockElement === k.canvas || document.webkitPointerLockElement === k.canvas || document.msPointerLockElement === k.canvas
    }
    if (!Zd) {
        Zd = !0;
        yc.push({
            canHandle: function(c) {
                return !k.nm && /\.(jpg|jpeg|png|bmp)$/i.test(c)
            },
            handle: function(c, d, e, f) {
                ...
                var h = URL.createObjectURL(g),
                    n = new Image;
                n.onload = () => {
                    n.complete || lb(`Image  could not be decoded`);
        ...
        b && (b.requestPointerLock = b.requestPointerLock || b.mozRequestPointerLock ||
            b.webkitRequestPointerLock || b.msRequestPointerLock || (() => {}), b.exitPointerLock = document.exitPointerLock || document.mozExitPointerLock || document.webkitExitPointerLock || document.msExitPointerLock || (() => {}), b.exitPointerLock = b.exitPointerLock.bind(document), document.addEventListener("pointerlockchange", a, !1), document.addEventListener("mozpointerlockchange", a, !1), document.addEventListener("webkitpointerlockchange", a, !1), document.addEventListener("mspointerlockchange", a, !1), k.elementPointerLock && b.addEventListener("click",
                c => {
                    !Xd && k.canvas.requestPointerLock && (k.canvas.requestPointerLock(), c.preventDefault())
                }, !1))
    }
}

function ae(a, b, c, d) {
    if (b && k.bj && a == k.canvas) return k.bj;
    var e;
    if (b) {
        var f = {
            antialias: !1,
        ...
        if ("undefined" != typeof be && (e = ce(a, f))) var h = de[e].Zi
    } else h = a.getContext("2d");
    if (!h) return null;
    c && (b || "undefined" == typeof S || lb("cannot set in module if GLctx is used, but we are a non-GL context that would replace it"), k.bj = h, b && ee(e), k.Ql = b, Yd.forEach(n => n()), Ac());
    return h
}
var fe = !1,
    ge = void 0,
...
function ie(a, b) {
    function c() {
        Wd = !1;
        var f = d.parentNode;
        (document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === f ? (d.exitFullscreen = je, ge && d.requestPointerLock(), Wd = !0, he ? ("undefined" != typeof SDL && (E[SDL.screen >> 2] = F[SDL.screen >> 2] | 8388608), ke(k.canvas), le()) : ke(d)) : (f.parentNode.insertBefore(d, f), f.parentNode.removeChild(f), he ? ("undefined" != typeof SDL && (E[SDL.screen >> 2] = F[SDL.screen >> 2] &
            -8388609), ke(k.canvas), le()) : ke(d));
        if (k.onFullScreen) k.onFullScreen(Wd);
        if (k.onFullscreen) k.onFullscreen(Wd)
    }
    ge = a;
    he = b;
    "undefined" == typeof ge && (ge = !0);
    "undefined" == typeof he && (he = !1);
    var d = k.canvas;
    fe || (fe = !0, document.addEventListener("fullscreenchange", c, !1), document.addEventListener("mozfullscreenchange", c, !1), document.addEventListener("webkitfullscreenchange", c, !1), document.addEventListener("MSFullscreenChange", c, !1));
...
function Jd(a) {
    if ("function" == typeof requestAnimationFrame) requestAnimationFrame(a);
        ...
        if (0 === me) me = b + 1E3 / 60;
            ...
            for (; b + 2 >= me;) me += 1E3 / 60;
        setTimeout(a, Math.max(me - b, 0))
    }
}
...
function le() {
    var a = k.canvas;
    ne.forEach(b => b(a.width, a.height))
}

function ke(a, b, c) {
    b && c ? (a.Tl = b, a.ul = c) : (b = a.Tl, c = a.ul);
    var d = b,
        e = c;
...
var zc = {},
    ...
    ye = a => {
        a.gm = a.getExtension("WEBGL_draw_instanced_base_vertex_base_instance")
    },
    ze = a => {
        a.lm = a.getExtension("WEBGL_multi_draw_instanced_base_vertex_base_instance")
    },
    Ae = 1,
    Be = [],
    Ce = {},
...
function Se(a) {
    Te = !1;
    for (var b = 0; b < R.Sk; ++b) {
        var c = R.kj[b];
        if (c.Gj && c.enabled) {
            Te = !0;
            var d = c.Yj;
            d = 0 < d ? a * d : c.size * Me[c.type - 5120] * a;
            ...
            S.bufferSubData(34962, 0, v.subarray(c.Ij, c.Ij + d));
            c.Dk.call(S, b, c.size, c.type, c.pk, c.Yj, 0)
        }
    }
}
var ce = (a, b) => {
        a.ck || (a.ck = a.getContext, a.getContext = function(d, e) {
            e = a.ck(d, e);
    ...
    Ue = (a, b) => {
        ...
        a.canvas && (a.canvas.Ej = d);
        de[c] = d;
        ("undefined" == typeof b.gk || b.gk) && Ve(d);
        d.Sk = d.Zi.getParameter(34921);
        d.kj = [];
        for (a = 0; a < d.Sk; a++) d.kj[a] = {
            enabled: !1,
            Gj: !1,
            size: 0,
            type: 0,
        ...
        d.pj = [];
        d.Zj = [];
        d.pj.length = d.Zj.length = 22;
        d.Dj = [];
        d.Kj = [];
        d.Dj.length = d.Kj.length = 22;
        d.Cj = [];
        d.Cj.length = 22;
        for (a = 0; 21 >= a; ++a) {
            d.Cj[a] = null;
    ...
    Ve = a => {
        ...
        if (!a.wl) {
            ...
            ye(b);
            ze(b);
            2 <= a.version && (b.aj = b.getExtension("EXT_disjoint_timer_query_webgl2"));
            if (2 > a.version || !b.aj) b.aj = b.getExtension("EXT_disjoint_timer_query");
            b.El = b.getExtension("WEBGL_multi_draw");
    ...
    Xe = (a, b) => {
        ...
        for (var c; c = v[a++];) {
            ...
            d &= 112 != c;
            b += d && b % 8 ? 4 : 0;
            We.push(112 == c ? F[b >> 2] : 105 == c ? E[b >> 2] : rb[b >> 3]);
            b += d ? 8 : 4
        }
        return We
    },
...
function ff() {
    for (var a = gf.length - 1; 0 <= a; --a) hf(a);
    gf = [];
    jf = []
}
var jf = [];
...
function kf(a, b, c) {
    ...
    jf.sort((g, h) => g.Xk < h.Xk)
}

function lf(a) {
    for (var b = 0; b < jf.length; ++b) jf[b].Ak == a && (jf.splice(b, 1), --b)
}

function mf() {
    return navigator.userActivation ? navigator.userActivation.isActive : ef && nf.Fj
}
...
function hf(a) {
    var b = gf[a];
    b.target.removeEventListener(b.Ti, b.ol, b.Wi);
    gf.splice(a, 1)
}
...
function pf(a) {
    ...
    if (a.Xi) a.ol = b, a.target.addEventListener(a.Ti, b, a.Wi), gf.push(a), qf || (wb.push(ff), qf = !0);
    else
        for (var c = 0; c < gf.length; ++c) gf[c].target == a.target && gf[c].Ti == a.Ti && hf(c--);
    return 0
}
...
var tf = {},
    qf, nf, uf, vf, wf, xf, yf, zf, Af, Bf, Cf, Df, Ef, Ff, Gf = {},
    Hf = [0, "undefined" != typeof document ? document : 0, "undefined" != typeof window ? window : 0],
    If = a => {
        a = 2 < a ? a ? x(v, a) : "" : a;
        return Hf[a] || ("undefined" != typeof document ? document.querySelector(a) : void 0)
    },
    Jf = (a, b, c) => {
        a = If(a);
        if (!a) return -4;
    ...
    Pf = a => {
        function b() {
            document.fullscreenElement || document.webkitFullscreenElement || (document.removeEventListener("fullscreenchange", b), document.removeEventListener("webkitfullscreenchange", b), Of(a, d, e), a.style.width = f, a.style.height = g, a.style.backgroundColor = h, n || (document.body.style.backgroundColor = "white"), document.body.style.backgroundColor = n, a.style.paddingLeft = p, a.style.paddingRight = q, a.style.paddingTop = u,
                a.style.paddingBottom = w, a.style.marginLeft = r, a.style.marginRight = B, a.style.marginTop = y, a.style.marginBottom = G, document.body.style.margin = L, document.documentElement.style.overflow = O, document.body.scroll = A, a.style.mj = P, a.Ej && a.Ej.Zi.viewport(0, 0, d, e), Gf.Oj && M(Gf.Oj)(37, 0, Gf.Jk))
        }
        var c = Mf(a),
            d = c[0],
            e = c[1],
    ...
    Rf = a => 0 > Hf.indexOf(a) ? a.getBoundingClientRect() : {
        left: 0,
        top: 0
    },
    Sf = (a, b) => {
        if (0 != b.wk || 0 != b.dk) {
            ...
            var g = Mf(a),
                h = g[0];
            g = g[1];
            3 == b.wk ? (Qf(a, (d - e) / 2, (c - f) / 2), c = f, d = e) : 2 == b.wk && (c * g < h * d ? (f = g * c / h, Qf(a, (d - f) / 2, 0), d = f) : (f = h * d / g, Qf(a, 0, (c - f) / 2), c = f));
            ...
            a.style.width = c + "px";
            a.style.height = d + "px";
            1 == b.ql && (a.style.mj = "optimizeSpeed", a.style.mj = "-moz-crisp-edges", a.style.mj = "-o-crisp-edges", a.style.mj =
                "-webkit-optimize-contrast", a.style.mj = "optimize-contrast", a.style.mj = "crisp-edges", a.style.mj = "pixelated");
            f = 2 == b.dk ? devicePixelRatio : 1;
            0 != b.dk && (c = c * f | 0, d = d * f | 0, Of(a, c, d), a.Ej && a.Ej.Zi.viewport(0, 0, c, d))
        }
    ...
    Uf = (a, b) => {
        rb[a >> 3] = b.timestamp;
        for (var c = 0; c < b.axes.length; ++c) rb[a + 8 * c + 16 >> 3] = b.axes[c];
        for (c = 0; c < b.buttons.length; ++c) rb[a + 8 * c + 528 >> 3] = "object" == typeof b.buttons[c] ? b.buttons[c].value : b.buttons[c];
...
var Wf = (a, b) => {
        S.attachShader(V[a], Ge[b])
    },
    Xf = (a, b) => {
        34962 == a ? S.zj = b : 34963 == a && (S.Hj = b);
        35051 == a ? S.fk = b : 35052 == a && (S.cj = b);
        S.bindBuffer(a, Be[b])
    },
    Yf = (a, b) => {
        S.bindFramebuffer(a, De[b])
    },
    Zf = (a, b) => {
        S.bindRenderbuffer(a, Ee[b])
    },
    $f = (a, b) => {
        S.bindTexture(a, Fe[b])
    },
    ag = a => {
        S.bindVertexArray(He[a]);
...
var eg = (a, b, c, d) => {
    2 <= R.version ? c && b ? S.bufferData(a, v, d, c, b) : S.bufferData(a, b, d) : S.bufferData(a, c ? v.subarray(c, c + b) : b, d)
};
...
var kg = (a, b, c, d) => {
    ...
    lg = a => {
        S.compileShader(Ge[a])
    },
    mg = (a, b, c, d, e, f, g, h) => {
        2 <= R.version ? S.cj || !g ? S.compressedTexImage2D(a, b, c, d, e, f, g, h) : S.compressedTexImage2D(a, b, c, d, e, f, v, h, g) : S.compressedTexImage2D(a, b, c, d, e, f, h ? v.subarray(h, h + g) : null)
    },
    ng = () => {
        var a = Re(V),
            b = S.createProgram();
    ...
    pg = (a, b) => {
        for (var c = 0; c < a; c++) {
            var d = E[b + 4 * c >> 2],
                e = Be[d];
            e && (S.deleteBuffer(e), e.name = 0,
                Be[d] = null, d == S.zj && (S.zj = 0), d == S.Hj && (S.Hj = 0), d == S.fk && (S.fk = 0), d == S.cj && (S.cj = 0))
        }
    },
    qg = (a, b) => {
        for (var c = 0; c < a; ++c) {
            var d = E[b + 4 * c >> 2],
                e = De[d];
            e && (S.deleteFramebuffer(e), e.name = 0, De[d] = null)
        }
    },
    rg = a => {
        if (a) {
    ...
    sg = (a, b) => {
        for (var c = 0; c < a; c++) {
            var d = E[b + 4 * c >> 2],
                e = Ee[d];
            e && (S.deleteRenderbuffer(e), e.name = 0, Ee[d] = null)
        }
    },
    tg = a => {
        if (a) {
            var b = Ge[a];
            b ? (S.deleteShader(b), Ge[a] = null) : W(1281)
        }
    },
    ug = (a, b) => {
        for (var c = 0; c < a; c++) {
            var d = E[b + 4 * c >> 2],
                e = Fe[d];
            e && (S.deleteTexture(e), e.name = 0, Fe[d] = null)
        }
    },
    vg = (a, b) => {
        for (var c = 0; c < a; c++) {
            var d = E[b + 4 * c >> 2];
            S.deleteVertexArray(He[d]);
            He[d] = null
        }
    };
...
var Ag = a => {
    ...
    Dg = [],
    Eg = (a, b) => {
        for (var c = Dg[a], d = 0; d < a; d++) c[d] = E[b + 4 * d >> 2];
        S.drawBuffers(c)
    },
    Fg = (a, b, c, d) => {
        if (!S.Hj) {
            ...
            var g = R.Cj[f];
            g ? f = g : (g = S.getParameter(34965), R.Cj[f] = S.createBuffer(), S.bindBuffer(34963, R.Cj[f]), S.bufferData(34963, 1 << f, 35048), S.bindBuffer(34963, g), f = R.Cj[f]);
            S.bindBuffer(34963, f);
            S.bufferSubData(34963, 0, v.subarray(d, d + e));
            d = 0
        }
        Se(b);
        S.drawElements(a, b, c, d);
        Te && S.bindBuffer(34962, Be[S.zj]);
        S.Hj || S.bindBuffer(34963, null)
    },
    Gg = (a, b, c, d, e) => {
...
var Kg = a => {
    ...
    Mg = (a, b, c, d) => {
        S.framebufferRenderbuffer(a, b, c, Ee[d])
    },
    Ng = (a, b, c, d, e) => {
        S.framebufferTexture2D(a, b, c, Fe[d],
            e)
    };
...
var Pg = (a, b, c, d) => {
    ...
    Qg = (a, b) => {
        Pg(a, b, "createBuffer", Be)
    },
    Rg = (a, b) => {
        Pg(a, b, "createFramebuffer", De)
    },
    Sg = (a, b) => {
        Pg(a, b, "createRenderbuffer", Ee)
    },
    Tg = (a, b) => {
        Pg(a, b, "createTexture", Fe)
    };

function Ug(a, b) {
    Pg(a, b, "createVertexArray", He)
}
var Vg = (a, b, c, d, e, f, g, h) => {
        b = V[b];
        if (a = S[a](b, c)) d = h && t(a.name, v, h, d), e && (E[e >> 2] = d), f && (E[f >> 2] = a.size), g && (E[g >> 2] = a.type)
    },
    Wg = (a, b, c, d, e, f, g) => {
        Vg("getActiveUniform", a, b, c, d, e, f, g)
    },
    Xg = (a, b) => S.getAttribLocation(V[a], b ? x(v, b) : ""),
    Yg = (a, b) => {
        F[a >> 2] = b;
    ...
    eh = (a, b, c) => {
        if (c)
            ...
            b) {
            if (!a.Sj)
                for (b = 0; b < S.getProgramParameter(a, 35718); ++b) a.Sj = Math.max(a.Sj, S.getActiveUniform(a, b).name.length + 1);
            E[c >> 2] = a.Sj
        } else if (35722 == b) {
            if (!a.Qj)
                for (b = 0; b < S.getProgramParameter(a, 35721); ++b) a.Qj = Math.max(a.Qj, S.getActiveAttrib(a, b).name.length + 1);
            E[c >> 2] = a.Qj
        } else if (35381 == b) {
            if (!a.Rj)
                for (b = 0; b < S.getProgramParameter(a, 35382); ++b) a.Rj = Math.max(a.Rj, S.getActiveUniformBlockName(a, b).length + 1);
            E[c >> 2] = a.Rj
    ...
    fh = (a, b, c) => {
        if (c) {
            a = Ie[a];
            b = 2 >
                R.version ? S.aj.getQueryObjectEXT(a, b) : S.getQueryParameter(a, b);
            var d;
    ...
    gh = (a, b, c) => {
        if (c) {
            a = S.aj.getQueryObjectEXT(Ie[a], b);
            var d;
    ...
    hh = (a, b, c, d) => {
        a = S.getShaderInfoLog(Ge[a]);
        null === a && (a = "(unknown error)");
        b = 0 < b && d ? t(a, v, d, b) : 0;
        c && (E[c >> 2] = b)
    },
    ih = (a, b, c) => {
        c ? 35716 == b ? (a = S.getShaderInfoLog(Ge[a]), null === a && (a = "(unknown error)"), E[c >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = S.getShaderSource(Ge[a]), E[c >>
            2] = a ? a.length + 1 : 0) : E[c >> 2] = S.getShaderParameter(Ge[a], b) : W(1281)
    },
    jh = a => {
        var b = Ne[a];
        if (!b) {
    ...
    kh = a => "]" == a.slice(-1) && a.lastIndexOf("["),
    lh = a => {
        var b = a.Lj,
            c = a.$k,
            d;
        if (!b)
            for (a.Lj = b = {}, a.Zk = {}, d = 0; d < S.getProgramParameter(a, 35718); ++d) {
    ...
    mh = (a, b) => {
        ...
        if (a = V[a]) {
            ...
            0 < f && (d = parseInt(b.slice(f +
                1)) >>> 0, e = b.slice(0, f));
            if ((e = a.$k[e]) && d < e[0] && (d += e[1], c[d] = c[d] || S.getUniformLocation(a, b))) return d
        } else W(1281);
        return -1
    },
    X = a => {
        ...
        if (b) {
            var c = b.Lj[a];
            "number" == typeof c && (b.Lj[a] = c = S.getUniformLocation(b, b.Zk[a] + (0 < c ? "[" + c + "]" : "")));
            return c
        }
        W(1282)
    },
    nh = (a, b, c, d) => {
        if (c)
            if (a = V[a], lh(a), a = S.getUniform(a, X(b)), "number" == typeof a || "boolean" == typeof a) switch (d) {
                case 0:
                    E[c >> 2] = a;
                    break;
                case 2:
    ...
    oh = (a, b, c, d) => {
        if (c)
            if (R.kj[a].enabled && l("glGetVertexAttrib*v on client-side array: not supported, bad data returned"), a = S.getVertexAttrib(a, b), 34975 == b) E[c >> 2] = a && a.name;
    ...
    th = a => {
        a -= 5120;
        return 0 == a ? D : 1 == a ? v : 2 == a ? pb : 4 == a ? E : 6 == a ? H : 5 == a || 28922 == a || 28520 == a || 30779 == a || 30782 == a ? F : qb
    },
    uh = (a, b, c, d, e) => {
        a = th(a);
    ...
    vh = (a, b, c, d, e, f, g) => {
        if (2 <= R.version)
            if (S.fk) S.readPixels(a, b, c, d, e,
                f, g);
            else {
                var h = th(f);
                S.readPixels(a, b, c, d, e, f, h, g >> 31 - Math.clz32(h.BYTES_PER_ELEMENT))
            }
        else(g = uh(f, e, c, d, g)) ? S.readPixels(a, b, c, d, e, f, g) : W(1280)
    };
...
var yh = (a, b, c, d) => {
    for (var e = "", f = 0; f < b; ++f) {
        var g = d ? E[d + 4 * f >> 2] : -1;
        e += td(E[c + 4 * f >> 2], 0 > g ? void 0 : g)
    }
    S.shaderSource(Ge[a], e)
};
...
var Ch = (a, b, c, d, e, f, g, h, n) => {
    if (2 <= R.version)
        if (S.cj) S.texImage2D(a, b, c, d, e, f, g, h, n);
        else if (n) {
        var p = th(h);
        S.texImage2D(a, b, c, d, e, f, g, h, p, n >> 31 - Math.clz32(p.BYTES_PER_ELEMENT))
    } else S.texImage2D(a, b, c, d, e, f, g, h, null);
    else S.texImage2D(a, b, c, d, e, f, g, h, n ? uh(h, g, d, e, n) : null)
};

function Dh(a, b, c) {
    S.texParameterf(a, b, c)
}
var Eh = (a, b, c, d, e, f, g, h, n) => {
        if (2 <= R.version)
            if (S.cj) S.texSubImage2D(a, b, c, d, e, f, g, h, n);
            else if (n) {
            var p = th(h);
            S.texSubImage2D(a, b, c, d, e, f, g, h, p, n >> 31 - Math.clz32(p.BYTES_PER_ELEMENT))
        } else S.texSubImage2D(a, b, c, d, e, f, g, h, null);
        else p = null, n && (p = uh(h, g, e, f, n)), S.texSubImage2D(a, b, c, d, e, f, g, h, p)
    },
    Fh = (a, b) => {
        S.uniform1f(X(a), b)
    },
    ...
    Hh = (a, b, c) => {
        if (2 <= R.version) b && S.uniform1fv(X(a), H, c >> 2, b);
            ...
            if (288 >= b)
                for (var d = Gh[b - 1], e = 0; e < b; ++e) d[e] = H[c + 4 * e >> 2];
    ...
    Kh = (a, b, c) => {
        if (2 <= R.version) b && S.uniform1iv(X(a), E, c >> 2, b);
            ...
            if (288 >= b)
                for (var d = Jh[b - 1], e = 0; e < b; ++e) d[e] = E[c + 4 * e >> 2];
    ...
    Lh = (a, b, c) => {
        if (2 <= R.version) b && S.uniform2fv(X(a), H, c >> 2, 2 * b);
            ...
            if (144 >= b)
                for (var d = Gh[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = H[c + 4 * e >> 2], d[e + 1] = H[c + (4 * e + 4) >> 2];
    ...
    Mh = (a, b, c) => {
        if (2 <= R.version) b && S.uniform2iv(X(a), E, c >> 2, 2 * b);
            ...
            if (144 >=
                b)
                for (var d = Jh[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = E[c + 4 * e >> 2], d[e + 1] = E[c + (4 * e + 4) >> 2];
    ...
    Nh = (a, b, c) => {
        if (2 <= R.version) b && S.uniform3fv(X(a), H, c >> 2, 3 * b);
            ...
            if (96 >= b)
                for (var d = Gh[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = H[c + 4 * e >> 2], d[e + 1] = H[c + (4 * e + 4) >> 2], d[e + 2] = H[c + (4 * e + 8) >> 2];
    ...
    Oh = (a, b, c) => {
        if (2 <= R.version) b && S.uniform3iv(X(a), E, c >> 2, 3 * b);
            ...
            if (96 >= b)
                for (var d = Jh[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = E[c + 4 * e >> 2], d[e + 1] = E[c +
    ...
    Qh = (a, b, c) => {
        if (2 <= R.version) b && S.uniform4iv(X(a), E, c >> 2, 4 * b);
            ...
            if (72 >= b)
                for (var d = Jh[4 * b - 1], e = 0; e < 4 * b; e += 4) d[e] = E[c + 4 * e >> 2], d[e + 1] = E[c + (4 * e + 4) >> 2], d[e + 2] = E[c +
    ...
    Rh = (a, b, c, d) => {
        if (2 <= R.version) b && S.uniformMatrix2fv(X(a), !!c, H, d >> 2, 4 * b);
            ...
            if (72 >= b)
                for (var e = Gh[4 * b - 1], f = 0; f < 4 * b; f += 4) e[f] = H[d + 4 * f >> 2], e[f + 1] = H[d + (4 * f + 4) >> 2], e[f + 2] = H[d + (4 * f + 8) >> 2], e[f + 3] = H[d + (4 * f + 12) >> 2];
    ...
    Sh = (a, b, c, d) => {
        if (2 <= R.version) b && S.uniformMatrix3fv(X(a), !!c, H, d >> 2, 9 * b);
            ...
            if (32 >= b)
                for (var e = Gh[9 * b - 1], f = 0; f < 9 * b; f += 9) e[f] = H[d +
    ...
    Wh = (a, b, c, d, e, f) => {
        var g = R.kj[a];
        S.zj ? (g.Gj = !1, S.vertexAttribPointer(a, b, c, !!d, e, f)) : (g.size = b, g.type = c, g.pk = d, g.Yj = e, g.Ij = f, g.Gj = !0, g.Dk = function(h, n, p, q, u, w) {
...
var Yh = (a, b) => {
        if (!sf()) return -1;
        a = If(a);
        return a ? a.requestFullscreen || a.webkitRequestFullscreen ? mf() ? Sf(a, b) : b.ll ? (kf(Sf, 1, [a, b]), 1) : -2 : -3 : -4
    },
    Zh = (a, b) => {
        var c = {
            target: If(2),
    ...
    ei = (a, b, c, d, e, f) => {
        ...
        return pf({
            target: a,
            Fj: "mousemove" != f && "mouseenter" != f && "mouseleave" != f,
            Ti: f,
            Xi: d,
            Yi: (g = event) => {
                di(Af, g, a);
                M(d)(e, Af, b) && g.preventDefault()
            },
            Wi: c
        })
    },
        ...
        return pf({
            ...
            Yi: (f = event) => {
                var g = Bf,
                    h = document.pointerLockElement || document.Ki || document.$i || document.Qi;
                E[g >> 2] = !!h;
                var n = h && h.id ? h.id : "";
                t(rf(h), v, g + 4, 128);
                t(n, v, g + 132, 128);
    ...
    hi = (a, b, c, d, e, f) => {
        ...
        return pf({
            target: a,
            Fj: "touchstart" == f || "touchend" == f,
            Ti: f,
            Xi: d,
            Yi: g => {
                for (var h, n = {}, p = g.touches, q = 0; q < p.length; ++q) h = p[q], h.Qk = h.Vk = 0, n[h.identifier] = h;
                for (q = 0; q < g.changedTouches.length; ++q) h = g.changedTouches[q], h.Qk = 1, n[h.identifier] =
                    h;
                for (q = 0; q < g.targetTouches.length; ++q) n[g.targetTouches[q].identifier].Vk = 1;
                p = Df;
                rb[p >> 3] = g.timeStamp;
                var u = p >> 2;
                E[u + 3] = g.ctrlKey;
                ...
                var w = Rf(a),
                    r = 0;
                for (q in n)
                    if (h = n[q], E[u] = h.identifier, E[u + 1] = h.screenX, E[u + 2] = h.screenY, E[u + 3] = h.clientX, E[u + 4] = h.clientY, E[u + 5] = h.pageX, E[u + 6] = h.pageY, E[u + 7] = h.Qk, E[u + 8] = h.Vk, E[u + 9] = h.clientX - w.left, E[u + 10] = h.clientY - w.top, u += 13, 31 < ++r) break;
                E[p + 8 >> 2] = r;
...
function oi(a, b, c, d, e) {
    function f() {
        var U = 0,
            fa = 0;
        A.response && L && 0 === F[a + 12 >> 2] && (fa = A.response.byteLength);
        0 < fa && (U = m(fa), v.set(new Uint8Array(A.response), U));
        F[a + 12 >> 2] = U;
        Yg(a + 16, fa);
        Yg(a + 24, 0);
        (U = A.response ? A.response.byteLength : 0) && Yg(a + 32, U);
        qb[a + 40 >> 1] = A.readyState;
        qb[a + 42 >> 1] = A.status;
        A.statusText && t(A.statusText, v, a + 44, 64)
    }
    var g = F[a + 8 >> 2];
    if (g) {
        var h = g ? x(v, g) : "",
        ...
        A.withCredentials = !!v[n + 60 >> 0];
        A.open(p, h, !G, u, w);
        G || (A.timeout = q);
        A.Qi = h;
        A.responseType = "arraybuffer";
        r && (h = r ? x(v, r) : "", A.overrideMimeType(h));
        if (g)
            for (;;) {
                n = F[g >> 2];
                if (!n) break;
        ...
        var P = mi.Nj(A);
        F[a >> 2] = P;
        g = B && y ? v.slice(B, B + y) : null;
        A.onload = U => {
            mi.has(P) && (f(), 200 <= A.status && 300 > A.status ? b && b(a, A, U) : c && c(a,
                A, U))
        };
        A.onerror = U => {
            mi.has(P) && (f(), c && c(a, A, U))
        };
        A.ontimeout = U => {
            mi.has(P) && c && c(a, A, U)
        };
        A.onprogress = U => {
            if (mi.has(P)) {
                var fa = L && O && A.response ? A.response.byteLength : 0,
                    Q = 0;
                0 < fa && L && O && (Q = m(fa), v.set(new Uint8Array(A.response), Q));
                F[a + 12 >> 2] = Q;
                Yg(a + 16, fa);
                Yg(a + 24, U.loaded - fa);
                Yg(a + 32, U.total);
        ...
        A.onreadystatechange = U => {
            mi.has(P) && (qb[a +
                40 >> 1] = A.readyState, 2 <= A.readyState && (qb[a + 42 >> 1] = A.status), e && e(a, A, U))
        };
        try {
            A.send(g)
        } catch (U) {
        ...
        try {
            ...
            f.onsuccess = g => {
                if (g.target.result) {
                    ...
                    t("OK", v, a + 44, 64);
                    b(a, 0, g)
                } else qb[a + 40 >> 1] = 4, qb[a + 42 >> 1] = 404, t("Not Found", v, a + 44, 64), c(a, 0, "no data")
            };
            f.onerror = g => {
                qb[a + 40 >> 1] = 4;
                qb[a + 42 >> 1] = 404;
...
var si = ["default", "low-power", "high-performance"],
    ti = [null],
    Y = null,
    ui = {},
    wi = () => {
        if (!vi) {
            var a = {
                ...
                b;
            for (b in ui) void 0 === ui[b] ? delete a[b] : a[b] = ui[b];
            var c = [];
...
function Ci(a) {
    ...
    b = zi(a);
    if (null !== b) return a;
    Bi[a] ? b = Bi[a] : (b = Ai++, 65535 > b || lb("exceeded max address mappings of 65535"), b = "172.29." + (b & 255) + "." + (b & 65280), Bi[a] = b);
    return b
}
var Di = a => (a & 255) + "." + (a >> 8 & 255) + "." + (a >> 16 & 255) + "." + (a >> 24 & 255),
    Ei = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
    ...
    Gi = (a, b, c, d) => {
        ...
        function n(r) {
            var B = r.wj;
            for (r = new Date((new Date(r.xj + 1900, 0, 1)).getTime()); 0 < B;) {
                var y = r.getMonth(),
                    G = (yd(r.getFullYear()) ? Ei : Fi)[y];
        ...
        p = {
            "%a": r => u[r.fj].substring(0,
                3),
            "%A": r => u[r.fj],
            "%b": r => w[r.ak].substring(0, 3),
            "%B": r => w[r.ak],
            "%C": r => f((r.xj + 1900) / 100 | 0, 2),
            "%d": r => f(r.Bk, 2),
            "%e": r => e(r.Bk, 2, " "),
            ...
            "%j": r => {
                for (var B = 0, y = 0; y <= r.ak - 1; B += (yd(r.xj + 1900) ? Ei : Fi)[y++]);
                return f(r.Bk + B, 3)
            },
            "%m": r => f(r.ak + 1, 2),
            "%M": r => f(r.Ml, 2),
            "%n": () => "\n",
            "%p": r => 0 <= r.$j && 12 > r.$j ? "AM" : "PM",
            "%S": r => f(r.Nl, 2),
            "%t": () => "\t",
            "%u": r => r.fj || 7,
            "%U": r => f(Math.floor((r.wj +
                7 - r.fj) / 7), 2),
            "%V": r => {
                var B = Math.floor((r.wj + 7 - (r.fj + 6) % 7) / 7);
                2 >= (r.fj + 371 - r.wj - 2) % 7 && B++;
                if (B) 53 == B && (y = (r.fj + 371 - r.wj) % 7, 4 == y || 3 == y && yd(r.xj) || (B = 1));
                else {
                    B = 52;
                    var y = (r.fj + 7 - r.wj - 1) % 7;
                    (4 == y || 5 == y && yd(r.xj % 400 - 1)) && B++
                }
                return f(B, 2)
            },
            "%w": r => r.fj,
            "%W": r => f(Math.floor((r.wj + 7 - (r.fj + 6) % 7) / 7), 2),
            "%y": r => (r.xj + 1900).toString().substring(2),
            "%Y": r => r.xj + 1900,
            "%z": r => {
                r = r.Ll;
                var B = 0 <= r;
    ...
    Ob = (a, b, c, d) => {
        ...
        if (d)
            for (var h = 0; h < d.length; h++) {
                var n = e[c[h]];
                n ? (0 === g && (g = bf()), f[h] = n(d[h])) : f[h] = d[h]
            }
        c = a.apply(null, f);
        return c = function(p) {
            0 !== g && cf(g);
            return "string" === b ? p ? x(v, p) :
                "" : "boolean" === b ? !!p : p
        }(c)
    };
...
k.FS_createPath = nd;
k.FS_createDataFile = Cc;
k.FS_createPreloadedFile = Dc;
k.FS_unlink = Va;
k.FS_createLazyFile = rd;
k.FS_createDevice = pd;
k.requestFullscreen = (a, b) => ie(a, b);
k.requestAnimationFrame = a => Jd(a);
...
k.createContext = (a, b, c, d) => ae(a, b, c, d);
for (var S, Hi = 0; 32 > Hi; ++Hi) Dg.push(Array(Hi));
var Ii = new Float32Array(288);
for (Hi = 0; 288 > Hi; ++Hi) Gh[Hi] = Ii.subarray(0, Hi + 1);
var Ji = new Int32Array(288);
for (Hi = 0; 288 > Hi; ++Hi) Jh[Hi] = Ji.subarray(0, Hi + 1);
mi = new li;
...
Object.assign(li.prototype, {
    ...
    has(a) {
        return void 0 !== this.yj[a]
    },
    Nj(a) {
        var b = this.Nk.pop() || this.yj.length;
        this.yj[b] = a;
        return b
    },
    rl(a) {
...
var Pi = {
        Tb: function(a) {
            try {
                ...
                if (null === b.node) throw new N(44);
                if (!C(b.node.mode)) throw new N(54);
                var c = Rc(b.node, "x");
                if (c) throw new N(c);
                hc = b.path;
                return 0
            } catch (d) {
                if ("undefined" == typeof sd || "ErrnoError" !== d.name) throw d;
                return -d.Pi
            }
        },
        Ia: function(a, b, c) {
            ...
            try {
                ...
                switch (b) {
                    ...
                    case 3:
                        return d.flags;
                    case 4:
                        return e = xd(), d.flags |= e, 0;
                    case 5:
                        return e = xd(), pb[e + 0 >> 1] = 2,
                            0;
                    case 6:
                    case 7:
                        return 0;
                ...
                if ("undefined" == typeof sd || "ErrnoError" !== f.name) throw f;
                return -f.Pi
            }
        },
        Kb: function(a, b, c) {
            try {
                ...
                d.uj || (d.uj = Ma(d.path));
                a = 0;
                for (var e = jd(d, 0, 1), f = Math.floor(e / 280); f < d.uj.length && a + 280 <= c;) {
                    var g = d.uj[f];
                    if ("." === g) {
                        var h = d.node.id;
                        var n = 4
                    } else if (".." === g) h = Oa(d.path, {
                        parent: !0
                    }).node.id, n = 4;
                    else {
                        var p = wc(d.node, g);
                ...
                if ("undefined" == typeof sd || "ErrnoError" !== q.name) throw q;
                return -q.Pi
            }
        },
        Ub: function(a, b, c) {
            ...
            try {
                ...
                switch (b) {
                    ...
                    case 21508:
                        if (!d.tty) return -59;
                        if (d.tty.ij.zl)
                            for (e = xd(), b = [], f = 0; 32 > f; f++) b.push(D[e + f + 17 >> 0]);
                        return 0;
                    case 21519:
                        if (!d.tty) return -59;
                        e = xd();
                    ...
                    case 21531:
                        e = xd();
                        if (!d.Ni.xl) throw new N(59);
                        return d.Ni.xl(d, b, e);
                    case 21523:
                        if (!d.tty) return -59;
                        d.tty.ij.Al && (f = [24, 80], e = xd(), pb[e >> 1] = f[0], pb[e + 2 >> 1] = f[1]);
                        return 0;
                    case 21524:
                        return d.tty ? 0 : -59;
                    case 21515:
                ...
                if ("undefined" == typeof sd || "ErrnoError" !== g.name) throw g;
                return -g.Pi
            }
        },
        Ob: function(a, b) {
            try {
                return a = a ? x(v, a) : "", vd(ed, a, b)
            } catch (c) {
                if ("undefined" == typeof sd || "ErrnoError" !== c.name) throw c;
                return -c.Pi
            }
        },
        Lb: function(a, b, c) {
            try {
                return b = b ? x(v, b) : "", b = ud(a, b), b = La(b), "/" === b[b.length - 1] && (b = b.substr(0, b.length - 1)), Pb(b, c), 0
            } catch (d) {
                if ("undefined" == typeof sd || "ErrnoError" !== d.name) throw d;
                return -d.Pi
            }
        ...
        Jb: function(a, b, c, d) {
            try {
                ...
                if ("undefined" == typeof sd || "ErrnoError" !== h.name) throw h;
                return -h.Pi
            }
        },
        Gb: function(a, b, c, d) {
            try {
                ...
                var q = n.node;
                if (!p || !q) throw new N(44);
                if (p.Si !== q.Si) throw new N(75);
                var u = wc(p, g),
                    w = ic(a, f);
                if ("." !== w.charAt(0)) throw new N(28);
                w = ic(d, e);
                if ("." !== w.charAt(0)) throw new N(55);
                try {
                    var r = wc(q, h)
                } catch (G) {}
                if (u !== r) {
                    var B = C(u.mode),
                        y = Vc(p, g, B);
                    if (y) throw new N(y);
                    if (y = r ? Vc(q, h, B) : Uc(q, h)) throw new N(y);
                    if (!p.Li.rename) throw new N(63);
                    if (u.nj || r && r.nj) throw new N(10);
                    if (q !== p && (y = Rc(p, "w"))) throw new N(y);
                    Qc(u);
                    try {
                        p.Li.rename(u, q, h)
                    } catch (G) {
        ...
        Hb: function(a) {
            try {
                ...
                if ("undefined" == typeof sd || "ErrnoError" !== b.name) throw b;
                return -b.Pi
            }
        },
        Qb: function(a, b) {
            try {
                return a = a ? x(v, a) : "", vd(Na, a, b)
            } catch (c) {
                if ("undefined" == typeof sd || "ErrnoError" !== c.name) throw c;
                return -c.Pi
            }
        ...
        Ib: function(a, b, c) {
            try {
                return b = b ? x(v, b) : "", b = ud(a, b), 0 === c ? Va(b) : 512 === c ? Ua(b) : lb("Invalid flags passed to unlinkat"), 0
            } catch (d) {
                if ("undefined" == typeof sd || "ErrnoError" !== d.name) throw d;
                return -d.Pi
            }
        ...
        bh: function(a, b, c) {
            a = mi.get(a).getAllResponseHeaders();
            var d = aa(a) + 1;
            t(a, v, b, c);
            return Math.min(d, c)
        },
        ch: function(a) {
            return aa(mi.get(a).getAllResponseHeaders()) + 1
        },
        Rb: () => !0,
        yb: function(a, b, c) {
        ...
        zb: function(a, b, c) {
            ...
            E[c + 24 >> 2] = a.getDay();
            E[c + 28 >> 2] = (yd(a.getFullYear()) ? zd : Ad)[a.getMonth()] + a.getDate() - 1 | 0;
        ...
        Ab: function(a) {
            ...
            E[a + 24 >> 2] = b.getDay();
            E[a + 28 >> 2] = (yd(b.getFullYear()) ?
                zd : Ad)[b.getMonth()] + b.getDate() - 1 | 0;
            E[a >> 2] = b.getSeconds();
            ...
            E[a + 20 >> 2] = b.getYear();
            a = b.getTime() / 1E3;
            return Mi((I = a, 1 <= +Math.abs(I) ? 0 < I ? +Math.floor(I / 4294967296) >>> 0 : ~~+Math.ceil((I - +(~~I >>> 0)) / 4294967296) >>> 0 : 0)), a >>> 0
        },
        Bb: function(a) {
        ...
        zh: (a, b, c, d, e) => {
            if (62E3 != a) T = 12296, c = 0;
                ...
                if (b)
                    for (;;) {
                        a = E[b >> 2];
                        if (12321 == a) se.alpha = 0 < E[b + 4 >> 2];
                        else if (12325 == a) se.depth = 0 < E[b + 4 >> 2];
                        else if (12326 == a) se.stencil = 0 < E[b + 4 >> 2];
                        else if (12337 == a) a = E[b + 4 >> 2], se.antialias = 0 < a;
                        else if (12338 == a) a = E[b + 4 >> 2], se.antialias = 1 == a;
                        else if (12544 == a) se.km = 12547 != E[b + 4 >> 2];
        ...
        mh: (a, b, c, d) => {
            ...
            se.Dl = 0;
            ue = ce(k.canvas, se);
            if (0 != ue) return T = 12288, ee(ue), k.Ql = !0, Yd.forEach(function(e) {
                e()
            }), ee(null), 62004;
            T = 12297;
            return 0
        ...
        nh: (a, b) => {
            ...
            if ("object" == typeof tf)
                for (var c =
                        de[a].Zi.canvas, d = 0; d < gf.length; ++d) gf[d].target != c || hf(d--);
            de[a] && de[a].Zi.canvas && (de[a].Zi.canvas.Ej = void 0);
            de[a] = null;
            T = 12288;
            pe == b && (pe = 0);
            return 1
        ...
        Ah: (a, b, c, d) => {
            ...
            switch (c) {
                case 12320:
                    return E[d >> 2] = se.alpha ? 32 : 24, 1;
                case 12321:
                    return E[d >> 2] = se.alpha ? 8 : 0, 1;
                case 12322:
                    return E[d >> 2] = 8, 1;
                case 12323:
                    return E[d >>
                ...
                case 12324:
                    return E[d >> 2] = 8, 1;
                case 12325:
                    return E[d >> 2] = se.depth ? 24 : 0, 1;
                case 12326:
                    return E[d >> 2] = se.stencil ? 8 : 0, 1;
                case 12327:
                ...
                case 12335:
                    return E[d >> 2] = 12344, 1;
                case 12337:
                    return E[d >> 2] = se.antialias ? 4 : 0, 1;
                case 12338:
                    return E[d >> 2] = se.antialias ?
                        1 : 0, 1;
                case 12339:
                    return E[d >> 2] = 4, 1;
                case 12340:
        ...
        Nh: (a, b, c, d, e, f, g, h) => {
            function n() {
                g && df(() => {
                    var w = 0;
                    q.statusText && (w = Lf(q.statusText));
                    M(g)(u, d, q.status, w)
                })
            }
            var p = a ? x(v,
            ...
            q.onprogress = function(w) {
                h && M(h)(u, d, w.loaded, w.lengthComputable || void 0 === w.lengthComputable ? w.total : 0)
            };
            q.onabort = function() {
                delete Ze[u]
            };
        ...
        Rh: Jf,
        x: () => "number" == typeof devicePixelRatio &&
            devicePixelRatio || 1,
        o: (a, b, c) => {
            a = If(a);
            if (!a) return -4;
        ...
        Zg: (a, b) => {
            S.aj.beginQueryEXT(a, Ie[b])
        },
        qd: function(a) {
            S.beginTransformFeedback(a)
        },
        Hg: (a, b, c) => {
            S.bindAttribLocation(V[a], b, c ? x(v, c) : "")
        },
        Gg: Xf,
        nd: (a, b, c) => {
            S.bindBufferBase(a, b, Be[c])
        },
        od: (a,
            b, c, d, e) => {
            S.bindBufferRange(a, b, Be[c], d, e)
        },
        Fg: Yf,
        Eg: Zf,
        vc: (a, b) => {
            S.bindSampler(a, Je[b])
        },
        Dg: $f,
        nc: (a, b) => {
            S.bindTransformFeedback(a, Ke[b])
        },
        vd: ag,
        Rg: ag,
        Cg: function(a, b, c, d) {
        ...
        xg: eg,
        wg: (a, b, c, d) => {
            2 <= R.version ? c && S.bufferSubData(a, b, v, d, c) : S.bufferSubData(a, b, v.subarray(d, d + c))
        },
        vg: fg,
        ug: gg,
        Sc: function(a, b, c, d) {
        ...
        sg: ig,
        rg: jg,
        Ec: (a, b, c, d) => S.clientWaitSync(Le[a], b, (c >>> 0) + 4294967296 * d),
        qg: kg,
        pg: lg,
        og: mg,
        Sd: (a, b, c, d, e, f, g, h, n) => {
            S.cj ? S.compressedTexImage3D(a, b, c, d, e, f, g, h, n) : S.compressedTexImage3D(a, b, c, d, e, f, g, v, n, h)
        },
        ng: (a, b, c, d, e, f, g, h, n) => {
            2 <= R.version ? S.cj || !h ? S.compressedTexSubImage2D(a, b, c, d, e, f, g, h, n) : S.compressedTexSubImage2D(a, b, c, d, e, f, g, v, n, h) : S.compressedTexSubImage2D(a, b, c, d, e, f, g, n ? v.subarray(n,
                n + h) : null)
        },
        Rd: (a, b, c, d, e, f, g, h, n, p, q) => {
            S.cj ? S.compressedTexSubImage3D(a, b, c, d, e, f, g, h, n, p, q) : S.compressedTexSubImage3D(a, b, c, d, e, f, g, h, n, v, q, p)
        },
        ...
        $g: (a, b) => {
            for (var c = 0; c < a; c++) {
                var d = E[b + 4 * c >> 2],
                    e = Ie[d];
                e && (S.aj.deleteQueryEXT(e), Ie[d] = null)
            }
        },
        eg: sg,
        xc: (a, b) => {
            for (var c = 0; c < a; c++) {
                var d = E[b + 4 * c >> 2],
                    e = Je[d];
                e && (S.deleteSampler(e), e.name = 0, Je[d] = null)
            }
        },
        dg: tg,
        Fc: a => {
            if (a) {
                var b = Le[a];
                b ? (S.deleteSync(b), b.name = 0, Le[a] = null) : W(1281)
            }
        },
        cg: ug,
        mc: (a, b) => {
            for (var c = 0; c < a; c++) {
                var d = E[b + 4 * c >> 2],
                    e = Ke[d];
                e && (S.deleteTransformFeedback(e), e.name = 0, Ke[d] = null)
            }
        },
        ud: vg,
        Qg: vg,
        ...
        Hc: (a, b) => (a = S.fenceSync(a, b)) ? (b = Re(Le), a.name = b, Le[b] = a, b) : 0,
        Tf: function() {
            S.finish()
        },
        Sf: Jg,
        wd: (a, b, c) => {
            if (Lg(a)) {
                var d = Ce[Kg(a)];
                d ? d.Fk & 16 ? 0 > b || 0 > c || b + c > d.length ? (W(1281), l("invalid range in glFlushMappedBufferRange")) :
                    S.bufferSubData(a, d.offset, v.subarray(d.hj + b, d.hj + b + c)) : (W(1282), l("buffer was not mapped with GL_MAP_FLUSH_EXPLICIT_BIT in glFlushMappedBufferRange")) : (W(1282), l("buffer was never mapped in glFlushMappedBufferRange"))
            } else W(1280), l("GL_INVALID_ENUM in glFlushMappedBufferRange")
        },
        Rf: Mg,
        Qf: Ng,
        yd: (a, b, c, d, e) => {
            S.framebufferTextureLayer(a, b, Fe[c], d, e)
        },
        Pf: Og,
        Of: Qg,
        Mf: Rg,
        Qd: (a, b) => {
            Pg(a, b, "createQuery", Ie)
        },
        ah: (a, b) => {
            for (var c = 0; c < a; c++) {
                var d = S.aj.createQueryEXT();
                if (!d) {
                    for (W(1282); c < a;) E[b + 4 * c++ >>
                        2] = 0;
                    break
                }
                var e = Re(Ie);
        ...
        Lf: Sg,
        yc: (a, b) => {
            Pg(a, b, "createSampler", Je)
        },
        Kf: Tg,
        lc: (a, b) => {
            Pg(a, b, "createTransformFeedback", Ke)
        },
        td: Ug,
        Pg: Ug,
        Nf: function(a) {
        ...
        Jf: (a, b, c, d, e, f, g) => {
            Vg("getActiveAttrib", a, b, c, d, e, f, g)
        },
        If: Wg,
        Lc: (a, b, c, d, e) => {
            a = V[a];
            if (a = S.getActiveUniformBlockName(a, b)) e && 0 < c ? (c = t(a, v, e, c), d && (E[d >> 2] = c)) : d && (E[d >> 2] = 0)
        },
        Mc: (a, b, c, d) => {
            if (d)
                if (a = V[a], 35393 == c) E[d >> 2] = S.getActiveUniformBlockName(a, b).length + 1;
                else {
                    if (a = S.getActiveUniformBlockParameter(a,
                            b, c), null !== a)
                        if (35395 == c)
        ...
        Hf: (a, b, c, d) => {
            ...
            e > b && (e = b);
            E[c >> 2] = e;
            for (b = 0; b < e; ++b) E[d + 4 * b >> 2] = Ge.indexOf(a[b])
        },
        Gf: Xg,
        Ff: (a, b) => {
            Zg(a, b, 4)
        ...
        zc: (a, b, c) => {
            c ? Yg(c, S.getBufferParameter(a, b)) : W(1281)
        },
        Ef: (a,
            b, c) => {
        ...
        Df: $g,
        Cf: ah,
        cd: (a, b) => S.getFragDataLocation(V[a], b ? x(v, b) : ""),
        Bf: (a, b, c, d) => {
        ...
        ac: (a, b, c, d, e) => {
            if (0 > d) W(1281);
                ...
                if (a =
                    S.getInternalformatParameter(a, b, c), null !== a)
        ...
        Wg: (a, b, c) => {
            c ? E[c >> 2] = S.aj.getQueryEXT(a, b) : W(1281)
        },
        xf: (a, b, c) => {
            c ? E[c >> 2] = S.getRenderbufferParameter(a, b) : W(1281)
        },
        pc: (a, b, c) => {
            c ? H[c >> 2] = S.getSamplerParameter(Je[a], b) : W(1281)
        },
        qc: (a,
            b, c) => {
            c ? E[c >> 2] = S.getSamplerParameter(Je[a], b) : W(1281)
        },
        vf: hh,
        uf: (a, b, c, d) => {
        ...
        tf: (a, b, c, d) => {
            if (a = S.getShaderSource(Ge[a])) b = 0 < b && d ? t(a, v, d, b) : 0, c && (E[c >> 2] = b)
        },
        wf: ih,
        sf: jh,
        Rc: (a, b) => {
            ...
            switch (a) {
                case 7939:
                    return c = S.getSupportedExtensions() || [], c = c.concat(c.map(function(d) {
                        ...
                        c = Oe[a] = c, 0 > b || b >= c.length ? (W(1281), 0) : c[b];
                default:
                    return W(1280), 0
            }
        },
        Bc: (a, b, c, d, e) => {
            0 > c ? W(1281) : e ? (a = S.getSyncParameter(Le[a], b), null !== a && (E[e >> 2] = a, d && (E[d >> 2] = 1))) : W(1281)
        },
        rf: (a, b, c) => {
        ...
        ld: (a, b, c, d, e, f, g) => {
            a = V[a];
            if (a = S.getTransformFeedbackVarying(a, b)) g && 0 < c ? (c = t(a.name, v, g, c), d && (E[d >> 2] = c)) : d && (E[d >> 2] = 0), e && (E[e >> 2] = a.size), f && (E[f >> 2] = a.type)
        },
        Nc: (a, b) => S.getUniformBlockIndex(V[a], b ? x(v, b) :
            ""),
        Pc: (a, b, c, d) => {
            if (d)
                if (0 < b && (0 == c || 0 == d)) W(1281);
                    ...
                    a = V[a];
                    for (var e = [], f = 0; f < b; f++) e.push(td(E[c + 4 * f >> 2]));
        ...
        id: ph,
        kf: (a, b, c) => {
            c ? (R.kj[a].enabled && l("glGetVertexAttribPointer on client-side array: not supported, bad data returned"), E[c >> 2] = S.getVertexAttribOffset(a, b)) : W(1281)
        },
        mf: (a, b, c) => {
            oh(a, b, c, 2)
        },
        ...
        ec: (a, b, c) => {
            for (var d = Dg[b], e = 0; e < b; e++) d[e] = E[c + 4 * e >> 2];
            S.invalidateFramebuffer(a, d)
        },
        dc: (a, b, c, d, e, f, g) => {
            for (var h = Dg[b], n = 0; n < b; n++) h[n] = E[c + 4 * n >> 2];
            S.invalidateSubFramebuffer(a, h, d, e, f, g)
        },
        hf: a => (a = Be[a]) ? S.isBuffer(a) : 0,
        gf: function(a) {
            return S.isEnabled(a)
        },
        ff: a => (a = De[a]) ? S.isFramebuffer(a) : 0,
        ef: a => (a = V[a]) ? S.isProgram(a) : 0,
        Od: a => (a = Ie[a]) ? S.isQuery(a) : 0,
        _g: a => (a = Ie[a]) ? S.aj.isQueryEXT(a) : 0,
        df: a => (a = Ee[a]) ? S.isRenderbuffer(a) : 0,
        wc: a => (a = Je[a]) ? S.isSampler(a) : 0,
        cf: a => (a = Ge[a]) ? S.isShader(a) : 0,
        Gc: a => S.isSync(Le[a]),
        bf: a => (a = Fe[a]) ? S.isTexture(a) : 0,
        kc: a => S.isTransformFeedback(Ke[a]),
        sd: qh,
        Og: qh,
        af: function(a) {
            S.lineWidth(a)
        ...
        xd: (a, b, c, d) => {
            ...
            if (!Lg(a)) return W(1280), l("GL_INVALID_ENUM in glMapBufferRange"),
                0;
            var e = m(c);
            a = Kg(a);
            if (!e) return 0;
        ...
        sc: (a, b, c) => {
            S.samplerParameterf(Je[a],
                b, c)
        },
        rc: (a, b, c) => {
            S.samplerParameterf(Je[a], b, H[c >> 2])
        },
        uc: (a, b, c) => {
            S.samplerParameteri(Je[a], b, c)
        },
        tc: (a, b, c) => {
            S.samplerParameteri(Je[a], b, E[c >> 2])
        },
        Te: xh,
        Se: () => {
            W(1280)
        ...
        Ud: (a, b, c, d, e, f, g, h, n, p, q) => {
            if (S.cj) S.texSubImage3D(a, b, c, d, e, f, g, h, n, p, q);
            else if (q) {
                var u = th(p);
        ...
        Cd: (a, b, c, d) => {
            b &&
                S.uniformMatrix3x4fv(X(a), !!c, H, d >> 2, 12 * b)
        },
        me: Th,
        Dd: (a, b, c, d) => {
        ...
        Jd: a => {
            if (!Lg(a)) return W(1280), l("GL_INVALID_ENUM in glUnmapBuffer"), 0;
            var b = Ce[Kg(a)];
            if (!b || !b.hj) return W(1282), l("buffer was never mapped in glUnmapBuffer"), 0;
            b.Fk & 16 || (2 <= R.version ? S.bufferSubData(a, b.offset, v, b.hj, b.length) : S.bufferSubData(a, b.offset, v.subarray(b.hj, b.hj + b.length)));
            ca(b.hj);
            b.hj = 0;
            return 1
        },
        ...
        kd: (a, b, c, d, e) => {
            var f = R.kj[a];
            S.zj ? (f.Gj = !1, S.vertexAttribIPointer(a, b, c, d, e)) : (f.size = b, f.type = c, f.pk = !1, f.Yj = d, f.Ij = e, f.Gj = !0, f.Dk = function(g, h, n, p, q, u) {
        ...
        ae: Xh,
        Dc: (a, b, c, d) => {
            S.waitSync(Le[a], b, (c >>> 0) + 4294967296 * d)
        },
        na: () => 0,
        fh: () => !ab,
        Sb: (a, b,
            c) => v.copyWithin(a, b, b + c),
        Eh: (a, b) => {
            function c(d) {
        ...
        ja: (a, b) => {
            a = If(a);
            return a ? a.requestPointerLock ? mf() ? Tf(a) : b ? (kf(Tf, 2, [a]), 1) : -2 : -1 : -4
        },
        Eb: a => {
            var b = v.length;
            a >>>= 0;
            ...
            for (var c = 1; 4 >= c; c *= 2) {
                ...
                a: {
                    e = (e.min.call(e, 2147483648, d + (65536 - d % 65536) % 65536) -
                        mb.buffer.byteLength + 65535) / 65536;
                    try {
                        mb.grow(e);
                        sb();
                        var f = 1;
        ...
        Za: () => (uf = navigator.getGamepads ? navigator.getGamepads() : navigator.webkitGetGamepads ? navigator.webkitGetGamepads() : null) ? 0 : -1,
        Qa: (a, b, c) => "undefined" == typeof onbeforeunload ? -1 : 1 !== c ? -5 : Zh(a, b),
        L: (a, b, c, d) => $h(a, b, c, d, 12, "blur"),
        s: Nf,
        ka: (a, b, c) => {
            a = If(a);
            if (!a) return -4;
        ...
        M: (a, b, c, d) => $h(a, b, c, d, 13, "focus"),
        ma: (a, b, c, d) => {
            if (!sf()) return -1;
            a = If(a);
            if (!a) return -4;
            ai(a, b, c, d, "webkitfullscreenchange");
            return ai(a, b, c, d, "fullscreenchange")
        },
        Xa: (a, b, c) => navigator.getGamepads || navigator.webkitGetGamepads ? bi(a, b, c, 26, "gamepadconnected") : -1,
        Wa: (a, b, c) => navigator.getGamepads || navigator.webkitGetGamepads ? bi(a, b, c, 27, "gamepaddisconnected") : -1,
        Dh: (a, b, c) => setInterval(() => {
            Qd(() => M(a)(c))
        }, b),
        T: (a, b, c, d) => ci(a, b, c, d, 2, "keydown"),
        la: (a, b, c, d) => ci(a, b, c, d, 1, "keypress"),
        S: (a, b, c, d) => ci(a, b, c, d, 3, "keyup"),
        R: (a, b, c, d) => ei(a, b, c, d, 5, "mousedown"),
        Ua: (a,
            b, c, d) => ei(a, b, c, d, 33, "mouseenter"),
        Ta: (a, b, c, d) => ei(a, b, c, d, 34, "mouseleave"),
        P: (a, b, c, d) => ei(a, b, c, d, 8, "mousemove"),
        Gh: (a, b, c, d) => ei(a, b, c, d, 35, "mouseover"),
        Q: (a, b, c, d) => ei(a, b, c, d, 6, "mouseup"),
        N: (a, b, c, d) => {
            if (!document || !document.body || !(document.body.requestPointerLock || document.body.ck || document.body.Wl || document.body.Ul)) return -1;
            a = If(a);
            if (!a) return -4;
            fi(a, b, c, d, "mozpointerlockchange");
            fi(a, b, c, d, "webkitpointerlockchange");
            fi(a, b, c, d, "mspointerlockchange");
            return fi(a, b, c, d, "pointerlockchange")
        },
        Sa: (a, b, c, d) => gi(a, b, c, d),
        H: (a, b, c, d) => hi(a, b, c, d, 25, "touchcancel"),
        J: (a, b, c, d) => hi(a, b, c, d, 23, "touchend"),
        I: (a, b, c, d) => hi(a, b, c, d, 24, "touchmove"),
        K: (a, b, c, d) => hi(a, b, c, d, 22, "touchstart"),
        Ra: (a, b, c) => Hf[1] ? ii(a, b, c) : -4,
        Lh: (a, b, c, d) => {
            ji(a, b, c, d, 31, "webglcontextlost");
            return 0
        },
        Jh: (a, b, c, d) => {
            ji(a, b, c, d, 32, "webglcontextrestored");
            return 0
        },
        O: (a, b, c, d) => (a = If(a)) ? "undefined" != typeof a.onwheel ? ki(a, b, c, d) : -1 : -4,
        ih: a => document.title = a ? x(v, a) : "",
        n: () => {
        ...
        eh: function(a, b, c, d, e) {
            ...
            var g = a + 112,
                ...
                fa = !!(u & 4);
            u = !!(u & 32);
            if ("EM_IDB_STORE" === P) L = F[g + 84 >> 2], pi(a, v.slice(L,
                L + F[g + 88 >> 2]), r, y);
            else if ("EM_IDB_DELETE" === P) ri(a, r, y);
            else if (U) {
                if (u) return 0;
                oi(a, fa ? O : r, y, B, G)
            } else qi(a, r, u ? y : fa ? A : L);
            return a
        },
        Qh: (a, b) => {
            b >>= 2;
            ...
            a = If(a);
            return !a || b.pl ? 0 : ce(a, b)
        },
        Ph: (a, b) => {
            a = de[a];
            b = b ? x(v, b) : "";
            b.startsWith("GL_") && (b = b.substr(3));
            "ANGLE_instanced_arrays" == b && ve(S);
            "OES_vertex_array_object" == b && we(S);
            "WEBGL_draw_buffers" == b && xe(S);
            "WEBGL_draw_instanced_base_vertex_base_instance" == b && ye(S);
            "WEBGL_multi_draw_instanced_base_vertex_base_instance" == b && ze(S);
            "WEBGL_multi_draw" == b && (S.El = S.getExtension("WEBGL_multi_draw"));
            return !!a.Zi.getExtension(b)
        },
        Hh: (a, b) => {
            if (!b) return -5;
            a = de[a];
            ...
            E[b + 24 >> 2] = c.powerPreference && si.indexOf(c.powerPreference);
            E[b + 28 >> 2] = c.failIfMajorPerformanceCaveat;
            E[b + 32 >> 2] = a.version;
            E[b + 36 >> 2] = 0;
            E[b + 40 >> 2] = a.attributes.gk;
            return 0
        },
        Ih: () => R ? R.handle : 0,
        Mh: a => {
        ...
        Ha: function(a, b, c, d) {
            try {
                a: {
                    ...
                    for (var f, g = b = 0; g < c; g++) {
                        ...
                        var p =
                            ...
                            w = f,
                            r = D;
                        if (0 > u || 0 > w) throw new N(28);
                        if (null === p.fd) throw new N(8);
                        if (1 === (p.flags & 2097155)) throw new N(8);
                        if (C(p.node.mode)) throw new N(31);
                        if (!p.Ni.read) throw new N(28);
                        var B = "undefined" != typeof w;
                        if (!B) w = p.position;
                        else if (!p.seekable) throw new N(70);
                        var y = p.Ni.read(p, r, q, u, w);
                        B || (p.position += y);
                        var G = y;
                        if (0 > G) {
                            var L = -1;
                ...
                if ("undefined" == typeof sd || "ErrnoError" !== O.name) throw O;
                return O.Pi
            }
        },
        Cb: function(a,
        ...
        Ga: function(a, b, c, d) {
            try {
                ...
                if ("undefined" == typeof sd || "ErrnoError" !== u.name) throw u;
                return u.Pi
            }
        },
        ph: (a, b, c, d) => {
            function e(u, w, r, B, y, G) {
                var L = 10 === u ? 28 : 16;
                if (10 === u) a: {
                    var O = "";
                    var A, P = 0,
                    ...
                    Q > P && (P = Q, fa = A - P + 1);
                    for (A = 0; 8 > A; A++) 1 < P && 0 === y[A] && A >= fa && A < fa + P ? A === fa && (O += ":", 0 === fa && (O += ":")) : (O += Number(Ni(y[A] & 65535)).toString(16), O += 7 > A ? ":" : "")
                }
                else O = Di(y);
                y = O;
                L = m(L);
            ...
            if (!a) return 0 === n && (n = 2), 0 === (h & 1) && (2 === n ? f = Oi(2130706433) : f = [0, 0, 0, 1]), a = e(n, p, q, null, f, g), F[d >> 2] = a, 0;
            a = a ? x(v, a) : "";
            f = xi(a);
            if (null !== f)
                if (0 === n || 2 === n) n = 2;
                else if (10 === n && h & 8) f = [0, 0, Oi(65535), f], n = 10;
            else return -2;
            else if (f = zi(a), null !== f)
                if (0 === n || 10 === n) n = 10;
                else return -2;
    ...
    Ni = a => (Ni = Z.$h)(a),
    Li = () => (Li = Z.ai)();
k._chat_callback = (a, b) => (k._chat_callback = Z.bi)(a, b);
k._join_game_callback = a => (k._join_game_callback = Z.ci)(a);
k._api_error_callback = (a, b) => (k._api_error_callback = Z.di)(a, b);
k._create_game_callback = (a, b, c) => (k._create_game_callback = Z.ei)(a, b, c);
k._player_info_callback = (a, b, c, d, e, f) => (k._player_info_callback = Z.fi)(a, b, c, d, e, f);
k._log_next_game_state = () => (k._log_next_game_state = Z.gi)();
k._start_game = () => (k._start_game = Z.hi)();
k._wallpaper_update_config = a => (k._wallpaper_update_config = Z.ii)(a);
k._wallpaper_reset_config = () => (k._wallpaper_reset_config = Z.ji)();
k._wallpaper_update_subscription_data = a => (k._wallpaper_update_subscription_data = Z.ki)(a);
k._video_playback_started = () => (k._video_playback_started = Z.li)();
k._video_playback_ended = () => (k._video_playback_ended = Z.mi)();
k._post_video_upload_callback = a => (k._post_video_upload_callback = Z.ni)(a);
k._GXC_FSSyncCompleted = () => (k._GXC_FSSyncCompleted = Z.oi)();
k._on_post_message_callback = (a, b) => (k._on_post_message_callback = Z.pi)(a, b);
k._on_orientation_update_callback = (a, b, c) => (k._on_orientation_update_callback = Z.qi)(a, b, c);
k._on_request_permission_callback = (a, b) => (k._on_request_permission_callback = Z.ri)(a, b);
k._YYSum = (a, b) => (k._YYSum = Z.si)(a, b);
var Qi = k._main = (a, b) => (Qi = k._main = Z.ti)(a, b);
k._FSSyncCompleted = () => (k._FSSyncCompleted = Z.ui)();
var Fb = () => (Fb = Z.vi)(),
    Mi = a => (Mi = Z.wi)(a),
    bf = () => (bf = Z.xi)(),
    cf = a => (cf = Z.yi)(a),
    Kf = a => (Kf = Z.zi)(a);
k.dynCall_viij = (a, b, c, d, e) => (k.dynCall_viij = Z.Ai)(a, b, c, d, e);
k.dynCall_vij = (a, b, c, d) => (k.dynCall_vij = Z.Bi)(a, b, c, d);
k.dynCall_iiiiiij = (a, b, c, d, e, f, g, h) => (k.dynCall_iiiiiij = Z.Ci)(a, b, c, d, e, f, g, h);
k.dynCall_iiji = (a, b, c, d, e) => (k.dynCall_iiji = Z.Di)(a, b, c, d, e);
k.dynCall_jiji = (a, b, c, d, e) => (k.dynCall_jiji = Z.Ei)(a, b, c, d, e);
k.dynCall_ji = (a, b) => (k.dynCall_ji = Z.Fi)(a, b);
k.dynCall_viijii = (a, b, c, d, e, f, g) => (k.dynCall_viijii = Z.Gi)(a, b, c, d, e, f, g);
k.dynCall_iiiiij = (a, b, c, d, e, f, g) => (k.dynCall_iiiiij = Z.Hi)(a, b, c, d, e, f, g);
k.dynCall_iiiiijj = (a, b, c, d, e, f, g, h, n) => (k.dynCall_iiiiijj = Z.Ii)(a, b, c, d, e, f, g, h, n);
k.dynCall_iiiiiijj = (a, b, c, d, e, f, g, h, n, p) => (k.dynCall_iiiiiijj = Z.Ji)(a, b, c, d, e, f, g, h, n, p);
k.addRunDependency = Db;
k.removeRunDependency = Eb;
k.FS_createPath = nd;
k.FS_createLazyFile = rd;
k.FS_createDevice = pd;
k.dynCall = Ub;
...
function Ti() {
    ...
    function b() {
        if (!Ri && (Ri = !0, k.calledRun = !0, !nb)) {
            yb = !0;
            k.noFSInit || md || (md = !0, ld(), k.stdin = k.stdin, k.stdout = k.stdout, k.stderr = k.stderr, k.stdin ? pd("/dev", "stdin", k.stdin) : dd("/dev/tty", "/dev/stdin"), k.stdout ? pd("/dev", "stdout", null, k.stdout) : dd("/dev/tty", "/dev/stdout"), k.stderr ? pd("/dev", "stderr", null, k.stderr) : dd("/dev/tty1", "/dev/stderr"), fd("/dev/stdin", 0), fd("/dev/stdout", 1), fd("/dev/stderr", 1));
            Kc = !1;
            Xb(ub);
            Xb(vb);
    ...
    if (!(0 < Ab)) {
        if (k.preRun)
            for ("function" == typeof k.preRun && (k.preRun = [k.preRun]); k.preRun.length;) zb();
        Xb(tb);
        0 < Ab || (k.setStatus ? (k.setStatus("Running..."), setTimeout(function() {
            setTimeout(function() {
                k.setStatus("")
            }, 1);
            b()
    ...
    if ("undefined" != typeof window && !window.Ki) {
        ...
        webtransport_async_connect = async (d, e) => {
            try {
                ...
                try {
                    d.sj = d.transport.datagrams.writable.getWriter()
                } catch (f) {
        ...
        class c {
            ...
            async send(d, e) {
                ...
                for (var f = 10; !this.sj && f;) await new Promise(n => setTimeout(n, 100)), f--;
                if (this.sj) {
